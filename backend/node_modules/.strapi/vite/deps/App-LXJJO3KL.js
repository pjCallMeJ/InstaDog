...
import {
  ...
  validateUrls
} from "./chunk-JZU7J36O.js";
import {
  ASSET_TYPES,
  typeFromMime
} from "./chunk-FQZ3CSHC.js";
import {
  PERMISSIONS
} from "./chunk-4OZLAMYY.js";
import {
  Item2,
  Root2
...
import {
  useDebounce
} from "./chunk-AEOFEHLU.js";
import {
  SubNav
} from "./chunk-XERJE3SI.js";
import "./chunk-BCSNVTCZ.js";
import "./chunk-GYHZQTMM.js";
import "./chunk-VEDPN45Y.js";
import "./chunk-JKTZEZPP.js";
import {
  getDisplayName
} from "./chunk-4R2QA5NM.js";
import "./chunk-TKXHHSNW.js";
import "./chunk-EXTWOOME.js";
import "./chunk-L2FILNLD.js";
import "./chunk-JTYZJMTC.js";
import {
  useClipboard
} from "./chunk-SYP5SQQS.js";
import {
  useAIAvailability,
  usePersistentState
} from "./chunk-W4LO662S.js";
import "./chunk-SWVKPTMF.js";
import "./chunk-4M3NXPXD.js";
import "./chunk-D6AWAV6D.js";
import "./chunk-OYW4LZNE.js";
import "./chunk-5CN55E7L.js";
import "./chunk-T5ATI4SA.js";
import "./chunk-MSCD7MZY.js";
import "./chunk-MBK4V2X7.js";
import "./chunk-3IYCN7IH.js";
import "./chunk-JRCQYP7F.js";
import "./chunk-EZ5PY57S.js";
import "./chunk-45QSVGD5.js";
import "./chunk-2SJR6F73.js";
import "./chunk-WWJ2T56O.js";
import "./chunk-A74Z7VC7.js";
import "./chunk-5ANRV6ST.js";
import "./chunk-DQQ2GUGV.js";
import "./chunk-D4WYVNVM.js";
import "./chunk-MMOBCIZG.js";
import "./chunk-K3A7T4HP.js";
import "./chunk-IFOFBKTA.js";
import "./chunk-AHFOBLQ3.js";
import "./chunk-A6QRMII5.js";
import "./chunk-7GSM5KPL.js";
import "./chunk-XXHDYA22.js";
import {
  Blocker,
  Form,
  useField,
  useForm
} from "./chunk-3K4LEXL4.js";
import {
  useRBAC
} from "./chunk-6TXUFPHL.js";
import {
  Layouts,
  useElementOnScreen
} from "./chunk-5N466YZK.js";
import {
  useIsDesktop,
  useIsMobile
...
import {
  useTracking
} from "./chunk-X6VMCHXU.js";
import "./chunk-LWR6MYK4.js";
import "./chunk-KVWVHPCR.js";
import {
  K,
  Page
} from "./chunk-LKTO47LV.js";
import {
  useQueryParams,
  withEncodedUserParams
} from "./chunk-XPH7Z2W4.js";
import {
  useNotification
} from "./chunk-WANEALNC.js";
import "./chunk-YN74PVVZ.js";
import "./chunk-ALJOKJHY.js";
import "./chunk-C7P74TZF.js";
...
import "./chunk-G3JODQDY.js";
import "./chunk-DBKEBTMX.js";
import "./chunk-GPEW3FZQ.js";
import {
  B3,
  F5,
  I2,
...
import "./chunk-GT23LO2G.js";
import "./chunk-T6XGOBD3.js";
import "./chunk-FM4ZLG4X.js";
...
// node_modules/@strapi/upload/dist/admin/future/hooks/useApiErrorMessage.mjs
var React = __toESM(require_react(), 1);

// node_modules/@strapi/upload/dist/admin/future/utils/getApiErrorMessage.mjs
...
var ASSET_DETAILS_TRIGGER_ATTRIBUTE = "data-asset-details-trigger";
var ASSET_DETAILS_TRIGGER_PROPS = {
  [ASSET_DETAILS_TRIGGER_ATTRIBUTE]: ""
};
var ASSET_ITEM_CONTROL_ATTRIBUTE = "data-asset-item-control";
var ASSET_ITEM_CONTROL_PROPS = {
  [ASSET_ITEM_CONTROL_ATTRIBUTE]: ""
};
var ASSET_ITEM_CONTROL_SELECTOR = `[${ASSET_ITEM_CONTROL_ATTRIBUTE}]`;
var ASSET_DETAILS_TRIGGER_SELECTOR = `[${ASSET_DETAILS_TRIGGER_ATTRIBUTE}]`;
var TABLE_HEADERS = [
  {
    name: "name",
    label: {
...
// node_modules/@strapi/upload/dist/admin/future/pages/Assets/hooks/useIsAssetDetailsOpen.mjs
var ASSET_DETAILS_URL_PARAM = "assetId";
var parseAssetDetailsId = (raw) => {
  const parsed = raw ? parseInt(raw, 10) : NaN;
  return Number.isNaN(parsed) ? null : parsed;
};
var useIsAssetDetailsOpen = () => {
  const [{ query }] = useQueryParams();
  return parseAssetDetailsId(query == null ? void 0 : query[ASSET_DETAILS_URL_PARAM]) !== null;
};
...
var BusyOverlayRoot = gt(C)`
  ...
  opacity: 0.7;
`;
var BusyOverlay = ({ children, zIndex = 20, hideLabel = false }) => (0, import_jsx_runtime.jsx)(BusyOverlayRoot, {
  $zIndex: zIndex,
...
var useCropImg = () => {
  const [naturalSize, setNaturalSize] = React2.useState({
    width: 0,
    height: 0
  });
  const [crop, setCrop] = React2.useState({
    x: 0,
    y: 0,
    width: 0,
    height: 0
  });
  const [aspectRatio, setAspectRatioState] = React2.useState(null);
  const imageRef = React2.useRef(null);
  const init = React2.useCallback((image) => {
  ...
  const setCropSize = React2.useCallback((next) => {
    setCrop((prev) => {
  ...
  const setCropPosition = React2.useCallback((next) => {
    setCrop((prev) => {
  ...
  const setAspectRatio = React2.useCallback((ratio) => {
  ...
  const produceFile = React2.useCallback((name, mimeType, lastModifiedDate) => new Promise((resolve, reject) => {
...
`;
var BackgroundPreserveRatio = () => (0, import_jsx_runtime2.jsx)(BackgroundPreserveRatioContainer, {
...
var AssetCropEditor = ({ asset, isBusy = false, onClose, onApply, onSaveAsCopy, canSaveAsCopy }) => {
  ...
  const imgRef = React3.useRef(null);
  const cropAreaRef = React3.useRef(null);
  ...
  const [aspectLocked, setAspectLocked] = React3.useState(false);
  const [focal, setFocal] = React3.useState(asset.focalPoint ?? {
    x: 50,
    y: 50
  });
  ...
  const activeDragCleanupRef = React3.useRef(null);
  React3.useEffect(() => {
    return () => {
      var _a;
  ...
  const [focalXKey, setFocalXKey] = React3.useState(0);
  const [focalYKey, setFocalYKey] = React3.useState(0);
  ...
  return (0, import_jsx_runtime2.jsx)(un, {
    children: (0, import_jsx_runtime2.jsx)(yu, {
      onEscape: onClose,
      skipAutoFocus: true,
      children: (0, import_jsx_runtime2.jsxs)(Overlay, {
        ref: overlayRef,
        tabIndex: -1,
        children: [
          (0, import_jsx_runtime2.jsxs)(HeaderBar, {
            alignItems: "center",
            children: [
              (0, import_jsx_runtime2.jsx)(S5, {
                "aria-hidden": true
              }),
          ...
          (0, import_jsx_runtime2.jsxs)(Body, {
            children: [
              (0, import_jsx_runtime2.jsxs)(CropArea, {
                ref: cropAreaRef,
                ...
                children: [
                  ...
                  cropPercents ? (0, import_jsx_runtime2.jsxs)(CropOverlay, {
                    style: {
                    ...
                    children: [
                      (0, import_jsx_runtime2.jsx)(ResizeHandle, {
                        type: "button",
                      ...
                      (0, import_jsx_runtime2.jsx)(FocalPointHandle, {
                        type: "button",
                        "aria-label": formatMessage({
              ...
              (0, import_jsx_runtime2.jsxs)(InfoBox, {
                children: [
                      ...
                      (0, import_jsx_runtime2.jsxs)(C, {
                        ...
                        children: [
                          (0, import_jsx_runtime2.jsxs)(C, {
                            ...
                            gap: 2,
                            children: [
                              (0, import_jsx_runtime2.jsxs)(FieldRow, {
                                name: "crop-width",
                                gap: 2,
                                children: [
                                  (0, import_jsx_runtime2.jsx)(LabelIcon, {
                                    textColor: infoTextColor,
                                    children: (0, import_jsx_runtime2.jsx)(Z2, {})
                                  }),
                                  (0, import_jsx_runtime2.jsx)(FieldNumberInput, {
                                    "aria-label": formatMessage({
                              ...
                              (0, import_jsx_runtime2.jsxs)(FieldRow, {
                                ...
                                children: [
                                  (0, import_jsx_runtime2.jsx)(LabelIcon, {
                                    textColor: infoTextColor,
                                    children: (0, import_jsx_runtime2.jsx)(N2, {})
                                  }),
                                  (0, import_jsx_runtime2.jsx)(FieldNumberInput, {
                                    "aria-label": formatMessage({
                          ...
                          (0, import_jsx_runtime2.jsxs)(C, {
                            ...
                            children: [
                              ...
                              (0, import_jsx_runtime2.jsx)(BackgroundPreserveRatio, {})
                            ]
                          })
                        ]
                      }),
          ...
          (0, import_jsx_runtime2.jsxs)(FooterBar, {
            alignItems: "center",
            children: [
              ...
              (0, import_jsx_runtime2.jsxs)(C, {
                gap: 2,
                children: [
                  canSaveAsCopy && (0, import_jsx_runtime2.jsx)(Ct, {
                    variant: "secondary",
...
var AssetLoader = () => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime3.jsx)(LoaderOverlay, {
    justifyContent: "center",
    alignItems: "center",
    children: (0, import_jsx_runtime3.jsx)(kt, {
      children: formatMessage({
        id: "app.loading",
...
var AssetPreview = ({ asset, actions, isLoading = false }) => {
  ...
  const [isMediaLoaded, setIsMediaLoaded] = React4.useState(false);
  React4.useEffect(() => {
  ...
  if (mime == null ? void 0 : mime.includes(ASSET_TYPES.Image)) {
    ...
    if (imageUrl) {
      return (0, import_jsx_runtime3.jsxs)(PreviewContainer, {
        children: [
          (!isMediaLoaded || isLoading) && (0, import_jsx_runtime3.jsx)(AssetLoader, {}),
          actions ? (0, import_jsx_runtime3.jsx)(ActionsOverlay, {
            children: actions
          }) : null,
          (0, import_jsx_runtime3.jsx)(AssetContainer, {
            children: (0, import_jsx_runtime3.jsx)(StyledImage, {
              ref: imageRef,
              src: imageUrl,
  ...
  if ((mime == null ? void 0 : mime.includes(ASSET_TYPES.Video)) && mediaUrl) {
    return (0, import_jsx_runtime3.jsxs)(PreviewContainer, {
      children: [
        !isMediaLoaded && (0, import_jsx_runtime3.jsx)(AssetLoader, {}),
        (0, import_jsx_runtime3.jsx)(AssetContainer, {
          children: (0, import_jsx_runtime3.jsx)(StyledVideo, {
            src: mediaUrl,
            controls: true,
            title: asset.name,
      ...
      children: [
        ...
        (0, import_jsx_runtime3.jsx)(AssetContainer, {
          children: (0, import_jsx_runtime3.jsx)(C, {
            ...
            height: "100%",
            minHeight: "12rem",
            children: (0, import_jsx_runtime3.jsx)(StyledAudio, {
              src: mediaUrl,
              controls: true,
              onLoadedData: () => setIsMediaLoaded(true),
              onError: () => setIsMediaLoaded(true)
  ...
  if (isPdf && mediaUrl) {
    return (0, import_jsx_runtime3.jsxs)(PreviewContainer, {
      children: [
        !isMediaLoaded && (0, import_jsx_runtime3.jsx)(AssetLoader, {}),
        (0, import_jsx_runtime3.jsx)(AssetContainer, {
          children: (0, import_jsx_runtime3.jsx)(StyledPdfIframe, {
  ...
  return (0, import_jsx_runtime3.jsx)(PreviewContainer, {
    children: (0, import_jsx_runtime3.jsxs)(IconFallback, {
      justifyContent: "center",
      alignItems: "center",
      gap: 1,
      direction: "column",
      hasRadius: true,
      children: [
        (0, import_jsx_runtime3.jsx)(DocIcon, {
          width: 24,
          height: 24
        }),
...
// node_modules/@strapi/upload/dist/admin/future/pages/Assets/components/AssetDetails/AssetDetailsDrawer.mjs
var DrawerNotifyContext = React5.createContext(null);
var useDrawerNotify = () => {
  const ctx = React5.useContext(DrawerNotifyContext);
  if (!ctx) {
    throw new Error("useDrawerNotify must be used within AssetDetails");
  }
  return ctx;
};
var AssetOperationsContext = React5.createContext(null);
var useAssetOperation = () => {
  const ctx = React5.useContext(AssetOperationsContext);
  if (!ctx) {
...
var useAssetDetailsParam = () => {
  ...
  const assetId = parseAssetDetailsId(query == null ? void 0 : query[ASSET_DETAILS_URL_PARAM]);
  const hasValidId = assetId !== null;
  const [isMounted, setIsMounted] = React5.useState(hasValidId);
  const displayAssetId = React5.useRef(null);
  React5.useEffect(() => {
    if (hasValidId) {
  ...
  const onCloseAnimationEnd = React5.useCallback((event) => {
  ...
  const openDetails = React5.useCallback((id) => {
  ...
  const closeDetails = React5.useCallback(() => {
    setQuery(withEncodedUserParams(query, {
      [ASSET_DETAILS_URL_PARAM]: void 0
    }), "push", true);
  }, [
    query,
    setQuery
...
`;
var DetailItem = ({ label, value }) => (0, import_jsx_runtime4.jsxs)(DetailItemContainer, {
  direction: "column",
...
var DetailField = ({ name, label, required, disabled }) => {
  ...
  const [value, setValue] = React5.useState(fieldValue);
  React5.useEffect(() => {
    setValue(fieldValue);
  }, [
    fieldValue
  ...
  return (0, import_jsx_runtime4.jsxs)(Dd.Root, {
    ...
    children: [
      ...
      (0, import_jsx_runtime4.jsx)(Pc, {
        value,
        onChange: (event) => {
          setValue(event.target.value);
          field.onChange(name, event.target.value);
        },
        endAction: !value ? (0, import_jsx_runtime4.jsx)(Mt, {
          label: emptyTooltipLabel,
          children: (0, import_jsx_runtime4.jsx)(StyledWarning, {
  ...
  return (0, import_jsx_runtime4.jsxs)(Dd.Root, {
    ...
    children: [
      ...
      (0, import_jsx_runtime4.jsxs)(cr, {
        ...
        disabled: isSubmitting || disabled,
        children: [
          (0, import_jsx_runtime4.jsx)(dr, {
            value: "",
            children: rootLabel
          }),
          folders.map((folder) => (0, import_jsx_runtime4.jsx)(dr, {
  ...
  return (0, import_jsx_runtime4.jsxs)(Pd.Root, {
    ...
    children: [
      (0, import_jsx_runtime4.jsx)(Pd.Trigger, {
        children: (0, import_jsx_runtime4.jsx)(be, {
          label: triggerLabel,
          variant: "danger-light",
          children: (0, import_jsx_runtime4.jsx)(In, {})
        })
      }),
      (0, import_jsx_runtime4.jsxs)(Pd.Content, {
        children: [
          (0, import_jsx_runtime4.jsx)(Pd.Header, {
            children: formatMessage({
              id: getTranslationKey("asset-details.delete.title"),
              defaultMessage: "Delete this media file?"
            })
          }),
          (0, import_jsx_runtime4.jsx)(Pd.Body, {
            icon: (0, import_jsx_runtime4.jsx)(Jn, {
              width: "24px",
              height: "24px",
              fill: "danger600"
            }),
          ...
          (0, import_jsx_runtime4.jsxs)(Pd.Footer, {
            children: [
              (0, import_jsx_runtime4.jsx)(Pd.Cancel, {
              ...
              (0, import_jsx_runtime4.jsx)(Pd.Action, {
                children: (0, import_jsx_runtime4.jsx)(Ct, {
                  variant: "danger-light",
                  loading: isDeleting,
...
var CopyLinkButton = ({ asset }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(be, {
    label: formatMessage({
    ...
    variant: "tertiary",
    onClick: handleCopy,
    children: (0, import_jsx_runtime4.jsx)(R3, {})
  });
};
var DownloadAssetButton = ({ asset }) => {
  const { formatMessage } = useIntl();
  const notify = useDrawerNotify();
  const [isDownloading, setIsDownloading] = React5.useState(false);
  ...
  return (0, import_jsx_runtime4.jsx)(be, {
    ...
    children: (0, import_jsx_runtime4.jsx)(z5, {})
  });
};
var ReplaceAssetButton = ({ mime }) => {
  ...
  const [isDialogOpen, setIsDialogOpen] = React5.useState(false);
  ...
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, {
    children: [
      ...
      (0, import_jsx_runtime4.jsx)(be, {
        ...
        children: (0, import_jsx_runtime4.jsx)(W2, {})
      }),
      (0, import_jsx_runtime4.jsx)(Pd.Root, {
        open: isDialogOpen,
        onOpenChange: setIsDialogOpen,
        children: (0, import_jsx_runtime4.jsxs)(Pd.Content, {
          children: [
            (0, import_jsx_runtime4.jsx)(Pd.Header, {
              children: formatMessage({
            ...
            (0, import_jsx_runtime4.jsx)(Pd.Body, {
              ...
              children: (0, import_jsx_runtime4.jsxs)(C, {
                ...
                children: [
                  ...
                  aiEnabled ? (0, import_jsx_runtime4.jsx)(A, {
                    variant: "omega",
                    children: formatMessage({
...
var AssetImageActions = ({ onCrop }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(C, {
    ...
    children: (0, import_jsx_runtime4.jsx)(be, {
      ...
      children: (0, import_jsx_runtime4.jsx)(S5, {})
    })
  });
};
var AssetDetails = ({ asset, closeDetails }) => {
  ...
  const [isCropOpen, setIsCropOpen] = React5.useState(false);
  const [drawerToast, setDrawerToast] = React5.useState(null);
  React5.useEffect(() => {
  ...
  const notify = React5.useCallback((toast) => setDrawerToast(toast), []);
  ...
  const handleReplace = React5.useCallback(async (file) => {
  ...
  const handleDelete = React5.useCallback(async () => {
  ...
  const operations = React5.useMemo(() => ({
  ...
  return (
    ...
    (0, import_jsx_runtime4.jsx)(DrawerNotifyContext.Provider, {
      value: notify,
      children: (0, import_jsx_runtime4.jsx)(AssetOperationsContext.Provider, {
        value: operations,
        children: (0, import_jsx_runtime4.jsx)(FormShell, {
          children: (0, import_jsx_runtime4.jsx)(Form, {
            method: "POST",
            initialValues,
            ...
            children: ({ modified, isSubmitting, values, resetForm }) => {
              ...
              return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, {
                children: [
                  ...
                  isCropOpen && isImage ? (0, import_jsx_runtime4.jsx)(AssetCropEditor, {
                    asset,
                  ...
                  busyMessage ? (0, import_jsx_runtime4.jsx)(BusyOverlay, {
                    children: formatMessage(busyMessage)
                  }) : null,
                  drawerToast ? (0, import_jsx_runtime4.jsx)(DrawerToastSlot, {
                    children: (0, import_jsx_runtime4.jsx)(ud, {
                  ...
                  (0, import_jsx_runtime4.jsxs)(Drawer.ScrollableContent, {
                    children: [
                      (0, import_jsx_runtime4.jsx)(AssetPreview, {
                        asset,
                        actions: isImage && canUpdate ? (0, import_jsx_runtime4.jsx)(AssetImageActions, {
                      ...
                      (0, import_jsx_runtime4.jsxs)(C, {
                        ...
                        children: [
                          ...
                          (0, import_jsx_runtime4.jsxs)(C, {
                            ...
                            alignItems: "flex-start",
                            children: [
                              (0, import_jsx_runtime4.jsx)(DetailItem, {
                                label: formatMessage({
                              ...
                              isImage && (asset.width != null || asset.height != null) && (0, import_jsx_runtime4.jsx)(DetailItem, {
                                label: formatMessage({
                          ...
                          (0, import_jsx_runtime4.jsx)(DetailField, {
                            name: "name",
                            label: formatMessage({
                          ...
                          (0, import_jsx_runtime4.jsx)(LocationField, {
                            label: formatMessage({
                  ...
                  (canUpdate || canCopyLink || canDownload) && (0, import_jsx_runtime4.jsxs)(C, {
                    ...
                    children: [
                      (0, import_jsx_runtime4.jsxs)(C, {
                        gap: 2,
                        children: [
                          canUpdate && (0, import_jsx_runtime4.jsx)(DeleteAssetButton, {}),
                          canCopyLink && (0, import_jsx_runtime4.jsx)(CopyLinkButton, {
                            asset
                          }),
                          canDownload && (0, import_jsx_runtime4.jsx)(DownloadAssetButton, {
                            asset
                          }),
                          canUpdate && (0, import_jsx_runtime4.jsx)(ReplaceAssetButton, {
                            mime: asset.mime
                          })
                        ]
                      }),
                      canUpdate && (0, import_jsx_runtime4.jsx)(Ct, {
                        type: "submit",
                        variant: "default",
...
var DrawerHeader = ({ asset, closeDetails }) => {
  ...
  return (0, import_jsx_runtime4.jsxs)(C, {
    ...
    children: [
      (0, import_jsx_runtime4.jsx)(HeaderIcon, {
        children: (0, import_jsx_runtime4.jsx)(DocIcon, {
          width: 20,
          height: 20
        })
      }),
      (0, import_jsx_runtime4.jsx)(Drawer.Title, {
        asChild: true,
        children: (0, import_jsx_runtime4.jsx)(HeaderTitle, {
          variant: "omega",
          fontWeight: "semiBold",
          overflow: "hidden",
          ellipsis: true,
      ...
      (0, import_jsx_runtime4.jsx)(S, {
        marginLeft: "auto",
        children: (0, import_jsx_runtime4.jsx)(Drawer.CloseButton, {
          onClose: closeDetails,
          children: (0, import_jsx_runtime4.jsx)(O2, {})
        })
      })
    ]
  });
...
var DrawerContent = ({ assetId, closeDetails }) => {
  ...
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, {
    children: [
      (0, import_jsx_runtime4.jsx)(DrawerHeader, {
        asset,
        closeDetails
      }),
      (0, import_jsx_runtime4.jsx)(AssetDetails, {
        asset,
        closeDetails
      })
    ]
...
var shouldKeepDrawerOpen = (event, isVisible) => {
  if (!isVisible) {
    return true;
  }
  ...
  return event.target.closest(ASSET_DETAILS_TRIGGER_SELECTOR) !== null && event.target.closest(ASSET_ITEM_CONTROL_SELECTOR) === null;
};
var AssetDetailsDrawer = () => {
  ...
  return (0, import_jsx_runtime4.jsxs)(Drawer.Root, {
    isVisible,
    onClose: closeDetails,
    children: [
      (0, import_jsx_runtime4.jsx)("div", {
        children: (0, import_jsx_runtime4.jsxs)($e, {
          children: [
            (0, import_jsx_runtime4.jsx)(Drawer.Title, {
              children: formatMessage({
            ...
            (0, import_jsx_runtime4.jsx)(Drawer.Description, {
              children: formatMessage({
      ...
      (0, import_jsx_runtime4.jsx)(Drawer.Body, {
        ...
        children: (0, import_jsx_runtime4.jsx)(DrawerContent, {
          assetId,
          closeDetails
        })
      })
...
// node_modules/@strapi/upload/dist/admin/future/pages/Assets/hooks/useAssetSelection.mjs
var AssetSelectionContext = (0, import_react2.createContext)(null);
var AssetSelectionProvider = ({ children, disabled = false }) => {
  const [state, setState] = (0, import_react2.useState)(createEmptySelection);
  const isSelected = (0, import_react2.useCallback)((key) => !disabled && state.selectedKeys.has(key), [
    disabled,
    state.selectedKeys
  ]);
  const toggle = (0, import_react2.useCallback)((key) => {
    if (disabled) return;
    setState((prev) => toggleSelection(prev, key));
  }, [
    disabled
  ]);
  const selectRange$1 = (0, import_react2.useCallback)((orderedKeys, targetKey) => {
    if (disabled) return;
    setState((prev) => selectRange(prev, orderedKeys, targetKey));
  }, [
    disabled
  ]);
  const selectAll$1 = (0, import_react2.useCallback)((orderedKeys) => {
    if (disabled) return;
    setState(selectAll(orderedKeys));
  }, [
    disabled
  ]);
  const deselect$1 = (0, import_react2.useCallback)((key) => setState((prev) => deselect(prev, key)), []);
  const clear = (0, import_react2.useCallback)(() => setState(clearSelection()), []);
  const selectedIds = (0, import_react2.useMemo)(() => getIdsOfKind(state.selectedKeys, "asset"), [
    state.selectedKeys
  ]);
  const selectedFolderIds = (0, import_react2.useMemo)(() => getIdsOfKind(state.selectedKeys, "folder"), [
    state.selectedKeys
  ]);
  ...
  return (0, import_react2.createElement)(AssetSelectionContext.Provider, {
    value
  }, children);
};
var useAssetSelection = () => {
  const context = (0, import_react2.useContext)(AssetSelectionContext);
  if (!context) {
    throw new Error("useAssetSelection must be used within an AssetSelectionProvider");
  }
  return context;
};
var useAssetSelectionOptional = () => (0, import_react2.useContext)(AssetSelectionContext);

// node_modules/@strapi/upload/dist/admin/future/pages/Assets/hooks/useBusyAssets.mjs
var import_react3 = __toESM(require_react(), 1);
var BusyAssetsContext = (0, import_react3.createContext)(null);
var BusyAssetsProvider = ({ children }) => {
  const [busyById, setBusyById] = (0, import_react3.useState)({});
  const markBusy = (0, import_react3.useCallback)((id, message) => {
    setBusyById((prev) => ({
      ...prev,
      [id]: message
    }));
  ...
  const isBusy = (0, import_react3.useCallback)((id) => busyById[id] !== void 0, [
    busyById
  ]);
  const getBusyMessage2 = (0, import_react3.useCallback)((id) => busyById[id] ?? null, [
    busyById
  ]);
  ...
  return (0, import_react3.createElement)(BusyAssetsContext.Provider, {
    value
  }, children);
};
var useBusyAssetsOptional = () => (0, import_react3.useContext)(BusyAssetsContext);
...
var useFolderNavigation = () => {
  ...
  const navigateToFolder = (0, import_react4.useCallback)((folder) => {
    setQuery({
  ...
  const navigateToRoot = (0, import_react4.useCallback)(() => {
    setQuery({
      folder: "",
      _q: ""
    }, "remove");
  ...
  const stripFolderParam = (0, import_react4.useCallback)(() => {
    setQuery(withEncodedUserParams(query, {
      folder: void 0
    }));
  }, [
  ...
  const navigateToFolderId = (0, import_react4.useCallback)((folderId) => {
    if (folderId == null) {
      navigateToRoot();
    } else {
      setQuery({
...
// node_modules/@strapi/upload/dist/admin/future/pages/Assets/utils/renderedKeys.mjs
var buildRenderedKeys = ({ folders, assets, mixedItems }) => mixedItems ? mixedItems.map((item) => item.kind === "folder" ? folderKey(item.folder.id) : assetKey(item.asset.id)) : [
...
var BulkMoveDialog = ({ open, onClose, items, onSuccess }) => {
  ...
  const fileIds = (0, import_react5.useMemo)(() => items.filter((item) => item.kind === "file").map((item) => item.id), [
    items
  ]);
  const folderIds = (0, import_react5.useMemo)(() => items.filter((item) => item.kind === "folder").map((item) => item.id), [
    items
  ]);
  ...
  const destinationOptions = (0, import_react5.useMemo)(() => flattenFolderStructure(folderStructure, new Set(folderIds)).filter((option) => canDropItemOnFolder({
    items,
  ...
  const canMoveToRoot = (0, import_react5.useMemo)(() => canDropItemOnFolder({
    items,
    targetFolderId: null,
    folderStructure
  }), [
    ...
    return (0, import_jsx_runtime5.jsxs)(Dd.Root, {
      ...
      children: [
        ...
        (0, import_jsx_runtime5.jsxs)(cr, {
          ...
          children: [
            canMoveToRoot && (0, import_jsx_runtime5.jsx)(dr, {
              value: "",
              children: rootLabel
            }),
            destinationOptions.map((option) => (0, import_jsx_runtime5.jsx)(dr, {
  ...
  return (0, import_jsx_runtime5.jsx)(_d.Root, {
    open,
    ...
    children: (0, import_jsx_runtime5.jsxs)(StyledModalContent, {
      children: [
        ...
        (0, import_jsx_runtime5.jsx)(_d.Footer, {
...
var DeleteItemsDialog = ({ open, onClose, target, onSuccess, onPendingChange }) => {
  ...
  return (0, import_jsx_runtime6.jsx)(Pd.Root, {
    open,
    onOpenChange: (nextOpen) => {
    ...
    children: (0, import_jsx_runtime6.jsxs)(Pd.Content, {
      children: [
        (0, import_jsx_runtime6.jsx)(Pd.Header, {
          children: formatMessage({
        ...
        (0, import_jsx_runtime6.jsx)(Pd.Body, {
          icon: (0, import_jsx_runtime6.jsx)(Jn, {
            width: "24px",
            height: "24px",
            fill: "danger600"
          }),
        ...
        (0, import_jsx_runtime6.jsxs)(Pd.Footer, {
          children: [
            (0, import_jsx_runtime6.jsx)(Pd.Cancel, {
            ...
            (0, import_jsx_runtime6.jsx)(Pd.Action, {
              children: (0, import_jsx_runtime6.jsx)(Ct, {
                variant: "danger-light",
                loading: isDeleting,
...
var AssetActionsMenu = ({ asset, dragData }) => {
  ...
  const [isReplaceOpen, setIsReplaceOpen] = (0, import_react7.useState)(false);
  const [isMoveOpen, setIsMoveOpen] = (0, import_react7.useState)(false);
  const [isDeleteOpen, setIsDeleteOpen] = (0, import_react7.useState)(false);
  const [isDownloading, setIsDownloading] = (0, import_react7.useState)(false);
  const moveItems = (0, import_react7.useMemo)(() => [
    dragData
  ], [
    dragData
  ]);
  ...
  return (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, {
    children: [
      ...
      (0, import_jsx_runtime7.jsxs)(gd.Root, {
        modal: false,
        children: [
          (0, import_jsx_runtime7.jsx)(gd.Trigger, {
            tag: be,
            icon: (0, import_jsx_runtime7.jsx)(W3, {}),
            variant: "ghost",
            label: formatMessage({
          ...
          (0, import_jsx_runtime7.jsxs)(ActionsMenuContent, {
            popoverPlacement: "bottom-end",
            zIndex: 2,
            minWidth: "22rem",
            children: [
              canUpdate && (0, import_jsx_runtime7.jsx)(gd.Item, {
                startIcon: (0, import_jsx_runtime7.jsx)(W2, {}),
                disabled: isReplacing,
              ...
              canCopyLink && (0, import_jsx_runtime7.jsx)(gd.Item, {
                startIcon: (0, import_jsx_runtime7.jsx)(R3, {}),
              ...
              canDownload && (0, import_jsx_runtime7.jsx)(gd.Item, {
                startIcon: (0, import_jsx_runtime7.jsx)(z5, {}),
                disabled: isDownloading,
              ...
              showSeparator && (0, import_jsx_runtime7.jsx)(gd.Separator, {}),
              canUpdate && (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, {
                children: [
                  (0, import_jsx_runtime7.jsx)(gd.Item, {
                    startIcon: (0, import_jsx_runtime7.jsx)(I2, {}),
                  ...
                  (0, import_jsx_runtime7.jsx)(gd.Item, {
                    startIcon: (0, import_jsx_runtime7.jsx)(In, {}),
                    variant: "danger",
            ...
            (0, import_jsx_runtime7.jsx)(Pd.Body, {
              ...
              children: (0, import_jsx_runtime7.jsxs)(C, {
                ...
                children: [
                  ...
                  aiEnabled ? (0, import_jsx_runtime7.jsx)(A, {
                    variant: "omega",
                    children: formatMessage({
                      id: getTranslationKey("asset-details.replace.description.ai"),
                      defaultMessage: "AI will generate new metadata after upload."
      ...
      isMoveOpen && (0, import_jsx_runtime7.jsx)(BulkMoveDialog, {
        open: true,
        onClose: () => setIsMoveOpen(false),
        items: moveItems,
        onSuccess: () => deselect2(assetKey(asset.id))
      }),
      isDeleteOpen && (0, import_jsx_runtime7.jsx)(DeleteItemsDialog, {
        open: true,
...
var DragOverlayChip = ({ items }) => {
  ...
  if (items.length === 1) {
    ...
    return (0, import_jsx_runtime8.jsxs)(Chip, {
      children: [
  ...
  return (0, import_jsx_runtime8.jsxs)(CompositeChip, {
    gap: 3,
    children: [
      folderCount > 0 ? (0, import_jsx_runtime8.jsxs)(CountGroup, {
        children: [
          (0, import_jsx_runtime8.jsx)(IconBox, {
            children: (0, import_jsx_runtime8.jsx)(_5, {
      ...
      fileCount > 0 ? (0, import_jsx_runtime8.jsxs)(CountGroup, {
        children: [
          (0, import_jsx_runtime8.jsx)(IconBox, {
            children: (0, import_jsx_runtime8.jsx)(Z5, {
      ...
      (0, import_jsx_runtime8.jsx)(TotalBadge, {
...
// node_modules/@strapi/upload/dist/admin/future/pages/Assets/components/Dnd/AssetsDndProvider.mjs
var AssetsDndContext = (0, import_react8.createContext)(null);
var useAssetsDndOptional = () => (0, import_react8.useContext)(AssetsDndContext);
...
var AssetsDndProvider = ({ children, locations = emptyItemLocations }) => {
  ...
  const [dragItems, setDragItems] = (0, import_react8.useState)([]);
  const [liveAnnouncement, setLiveAnnouncement] = (0, import_react8.useState)("");
  const dragSessionRef = (0, import_react8.useRef)({
    items: [],
    fromSelection: false,
    activeSourceFolderId: null,
    spansMultipleSources: false
  });
  const announceToLiveRegion = (0, import_react8.useCallback)((message) => {
    setLiveAnnouncement("");
  ...
  const validDropTargets = (0, import_react8.useMemo)(() => computeValidDropTargets(dragItems, folderStructure), [
    dragItems,
    folderStructure
  ]);
  const isValidDropTarget = (0, import_react8.useCallback)((targetFolderId) => validDropTargets.has(targetFolderId), [
    validDropTargets
  ]);
  ...
  const clearDragState = (0, import_react8.useCallback)(() => {
  ...
  const handleDragStart = (0, import_react8.useCallback)((event) => {
  ...
  const handleDragEnd = (0, import_react8.useCallback)(async (event) => {
    const { over } = event;
  ...
  const handleDragCancel = (0, import_react8.useCallback)(() => {
    clearDragState();
  }, [
    clearDragState
  ]);
  const announcements = (0, import_react8.useMemo)(() => ({
    onDragStart: ({ active }) => {
  ...
  return (0, import_jsx_runtime9.jsx)(AssetsDndContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime9.jsxs)(DndContext, {
      sensors,
      ...
      children: [
        ...
        (0, import_jsx_runtime9.jsx)(DragOverlay, {
          dropAnimation: null,
          modifiers: OVERLAY_MODIFIERS,
          children: dragItems.length > 0 ? (0, import_jsx_runtime9.jsx)(DragOverlayChip, {
            items: dragItems
          }) : null
        })
      ]
...
var useFolderDraggableDroppable = (folder) => {
  ...
  const dragData = (0, import_react9.useMemo)(() => ({
    kind: "folder",
    id: folder.id,
    name: folder.name,
    parentId
  ...
  const dropData = (0, import_react9.useMemo)(() => ({
    kind: "folder-target",
    id: folder.id,
    name: folder.name
  }), [
...
var FolderFormDialog = (props) => {
  ...
  const { toggleNotification } = useNotification();
  const { trackUsage } = useTracking2();
  const [name, setName] = (0, import_react10.useState)(initialName);
  const [fieldError, setFieldError] = (0, import_react10.useState)();
  ...
  return (0, import_jsx_runtime10.jsx)(_d.Root, {
    open,
    onOpenChange: onClose,
    children: (0, import_jsx_runtime10.jsxs)(StyledModalContent2, {
      children: [
        (0, import_jsx_runtime10.jsx)(_d.Header, {
          children: (0, import_jsx_runtime10.jsx)(_d.Title, {
        ...
        (0, import_jsx_runtime10.jsxs)("form", {
          onSubmit: handleSubmit,
          children: [
            (0, import_jsx_runtime10.jsx)(_d.Body, {
              children: (0, import_jsx_runtime10.jsxs)(Dd.Root, {
                error: fieldError,
                name: "name",
                required: true,
                children: [
            ...
            (0, import_jsx_runtime10.jsx)(_d.Footer, {
...
var FolderActionsMenu = ({ folder, dragData }) => {
  ...
  const { toggleNotification } = useNotification();
  const { deselect: deselect2 } = useAssetSelection();
  const [isRenameOpen, setIsRenameOpen] = (0, import_react11.useState)(false);
  const [isMoveOpen, setIsMoveOpen] = (0, import_react11.useState)(false);
  const [isDeleteOpen, setIsDeleteOpen] = (0, import_react11.useState)(false);
  const moveItems = (0, import_react11.useMemo)(() => [
    dragData
  ], [
    dragData
  ]);
  ...
  return (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, {
    children: [
      (0, import_jsx_runtime11.jsxs)(gd.Root, {
        modal: false,
        children: [
          (0, import_jsx_runtime11.jsx)(gd.Trigger, {
            tag: be,
            icon: (0, import_jsx_runtime11.jsx)(W3, {}),
            variant: "ghost",
            label: formatMessage({
              id: getTranslationKey("control-card.more-actions"),
              defaultMessage: "More actions"
          ...
          (0, import_jsx_runtime11.jsxs)(ActionsMenuContent, {
            popoverPlacement: "bottom-end",
            zIndex: 2,
            minWidth: "22rem",
            children: [
              (0, import_jsx_runtime11.jsx)(gd.Item, {
                startIcon: (0, import_jsx_runtime11.jsx)(R3, {}),
                onSelect: handleCopyLink,
                children: formatMessage({
              ...
              (0, import_jsx_runtime11.jsx)(gd.Separator, {}),
              (0, import_jsx_runtime11.jsx)(gd.Item, {
              ...
              (0, import_jsx_runtime11.jsx)(gd.Item, {
                startIcon: (0, import_jsx_runtime11.jsx)(I2, {}),
                onSelect: () => setIsMoveOpen(true),
                children: formatMessage({
              ...
              (0, import_jsx_runtime11.jsx)(gd.Item, {
                startIcon: (0, import_jsx_runtime11.jsx)(In, {}),
                variant: "danger",
                onSelect: () => setIsDeleteOpen(true),
                children: formatMessage({
      ...
      isRenameOpen && (0, import_jsx_runtime11.jsx)(FolderFormDialog, {
        open: true,
        mode: "rename",
        folderId: folder.id,
      ...
      isMoveOpen && (0, import_jsx_runtime11.jsx)(BulkMoveDialog, {
        open: true,
        onClose: () => setIsMoveOpen(false),
        items: moveItems,
        onSuccess: () => deselect2(folderKey(folder.id))
      }),
      isDeleteOpen && (0, import_jsx_runtime11.jsx)(DeleteItemsDialog, {
        open: true,
        onClose: () => setIsDeleteOpen(false),
        target: {
          fileIds: [],
...
var FolderCard = ({ folder, orderedItemKeys }) => {
  ...
  return (0, import_jsx_runtime12.jsxs)(StyledFolderCard, {
    ...
    children: [
      canUpdate && (0, import_jsx_runtime12.jsx)(C, {
        onKeyDown: (e) => e.stopPropagation(),
        children: (0, import_jsx_runtime12.jsx)(Bt, {
      ...
      (0, import_jsx_runtime12.jsx)(FolderIconContainer, {
        children: (0, import_jsx_runtime12.jsx)(_5, {
          width: 20,
          height: 20
        })
      }),
      ...
      (0, import_jsx_runtime12.jsx)(C, {
        ...
        children: (0, import_jsx_runtime12.jsx)(FolderActionsMenu, {
          folder,
          dragData
        })
      })
...
var AssetCard = ({ asset, orderedItemKeys, onAssetItemClick }) => {
  ...
  return (0, import_jsx_runtime12.jsxs)(StyledCard, {
    ...
    children: [
      (0, import_jsx_runtime12.jsxs)(StyledCardHeader, {
        children: [
          canUpdate && (0, import_jsx_runtime12.jsx)(CheckboxOverlay, {
          ...
          (0, import_jsx_runtime12.jsx)(AssetPreview2, {
            asset
          }),
          busyMessage !== null ? (0, import_jsx_runtime12.jsx)(BusyOverlay, {
            zIndex: 2,
            children: busyMessage
          }) : null
        ]
      }),
      (0, import_jsx_runtime12.jsx)(xd, {
        children: (0, import_jsx_runtime12.jsxs)(CardFooter, {
          ...
          children: [
            ...
            (0, import_jsx_runtime12.jsx)(NameButton, {
              type: "button",
              onClick: handleNameClick,
              children: (0, import_jsx_runtime12.jsx)(FileName, {
            ...
            (0, import_jsx_runtime12.jsx)(C, {
              ...
              onKeyDown: stopCardEvent,
              onPointerDown: stopCardEvent,
              children: (0, import_jsx_runtime12.jsx)(AssetActionsMenu, {
                asset,
                dragData
              })
            })
...
var AssetsGrid = ({ assets, folders = [], renderedKeys, onAssetItemClick }) => {
  ...
  return (0, import_jsx_runtime12.jsxs)(Ld.Root, {
    gap: 4,
    role: "list",
    "data-testid": "assets-grid",
    children: [
      folders.length > 0 && (0, import_jsx_runtime12.jsx)(FoldersRow, {
        children: (0, import_jsx_runtime12.jsx)(Ld.Root, {
          gap: 4,
          children: folders.map((folder) => (0, import_jsx_runtime12.jsx)(Ld.Item, {
            col: 3,
            m: 4,
            s: 6,
            xs: 12,
      ...
      assets.map((asset) => (0, import_jsx_runtime12.jsx)(Ld.Item, {
        col: 3,
        m: 4,
        s: 6,
        xs: 12,
...
var useAssetSearch = () => {
  ...
  const setSearchQuery = (0, import_react12.useCallback)((value) => {
    if (value) {
      setQuery({
  ...
  const clearSearch = (0, import_react12.useCallback)(() => setSearchQuery(""), [
    setSearchQuery
  ]);
  return {
    searchQuery,
...
var AssetsSearchInput = () => {
  ...
  const [value, setValue] = (0, import_react13.useState)(searchQuery);
  const debouncedValue = useDebounce(value, DEBOUNCE_MS);
  const lastCommittedRef = (0, import_react13.useRef)(searchQuery);
  const [{ query }] = useQueryParams();
  const folderParam = (query == null ? void 0 : query.folder) ?? "";
  const lastFolderRef = (0, import_react13.useRef)(folderParam);
  ...
  const searchForm = (0, import_jsx_runtime13.jsx)(StyledSearchForm, {
    onSubmit: (event) => event.preventDefault(),
    children: (0, import_jsx_runtime13.jsx)(Yl, {
      name: "search-assets",
      value,
  ...
  if (isMobile) {
    return (0, import_jsx_runtime13.jsx)(S, {
      width: "100%",
      children: searchForm
    });
  }
...
var StyledTd = gt(Dn)`
  ...
  border-bottom: 1px solid ${({ theme }) => theme.colors.neutral150};
`;
var NameTd = gt(StyledTd)`
  ${flexColumn}
`;
var HugTd = gt(StyledTd)`
  ${hugColumn}
`;
var StyledTr = gt.tr`
  height: 48px;
...
var AssetPreviewCell = ({ asset }) => {
  ...
  const DocIcon = getAssetIcon(mime, ext);
  return (0, import_jsx_runtime14.jsx)(C, {
    justifyContent: "center",
    alignItems: "center",
    borderRadius: "4px",
    color: "neutral500",
...
var AssetRow = ({ asset, orderedItemKeys, onAssetItemClick }) => {
  ...
  return (0, import_jsx_runtime14.jsxs)(StyledTr, {
    ref: setNodeRef,
    ...attributes,
    ...listeners,
    ...ASSET_DETAILS_TRIGGER_PROPS,
    ...
    children: [
      canUpdate && (0, import_jsx_runtime14.jsx)(CheckboxTd, {
        ...ASSET_ITEM_CONTROL_PROPS,
        onClick: stopRowEvent,
        onKeyDown: stopRowEvent,
        children: (0, import_jsx_runtime14.jsx)(C, {
      ...
      (0, import_jsx_runtime14.jsx)(NameTd, {
        children: (0, import_jsx_runtime14.jsxs)(C, {
          alignItems: "center",
          justifyContent: "space-between",
          gap: 2,
          minWidth: 0,
          children: [
            (0, import_jsx_runtime14.jsxs)(C, {
              gap: 3,
              alignItems: "center",
              minWidth: 0,
              children: [
                busyMessage !== null ? (0, import_jsx_runtime14.jsx)(C, {
                  justifyContent: "center",
                  width: "3.2rem",
                  height: "3.2rem",
                  children: (0, import_jsx_runtime14.jsx)(kt, {
                    small: true,
                    children: busyMessage
                  })
                }) : (0, import_jsx_runtime14.jsx)(AssetPreviewCell, {
                  asset
                }),
                (0, import_jsx_runtime14.jsxs)(C, {
                  direction: "column",
                  ...
                  minWidth: 0,
                  children: [
                    (0, import_jsx_runtime14.jsx)(NameButton2, {
                      type: "button",
                      onClick: handleNameClick,
                      children: (0, import_jsx_runtime14.jsx)(TruncatedText, {
                        textColor: "neutral800",
                        fontWeight: "semiBold",
                        children: asset.name
                      })
                    }),
                    !isDesktop && (0, import_jsx_runtime14.jsx)(A, {
                      textColor: "neutral600",
                      variant: "pi",
            ...
            isMetadataMissing && (0, import_jsx_runtime14.jsx)(Mt, {
              label: metadataMissingLabel,
              children: (0, import_jsx_runtime14.jsx)(MetadataWarning, {
      ...
      isDesktop && (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, {
        children: [
          (0, import_jsx_runtime14.jsx)(HugTd, {
            children: (0, import_jsx_runtime14.jsx)(A, {
              textColor: "neutral600",
      ...
      (0, import_jsx_runtime14.jsx)(StyledTd, {
        ...ASSET_ITEM_CONTROL_PROPS,
        onClick: stopRowEvent,
        onKeyDown: stopRowEvent,
...
var FolderRow = ({ folder, orderedItemKeys }) => {
  ...
  return (0, import_jsx_runtime14.jsxs)(FolderTr, {
    ref: (node) => {
      setDragRef(node);
      setDropRef(node);
    },
      ...
      (0, import_jsx_runtime14.jsx)(NameTd, {
        children: (0, import_jsx_runtime14.jsxs)(C, {
          ...
          children: [
            ...
            (0, import_jsx_runtime14.jsx)(TruncatedText, {
              textColor: "neutral800",
              fontWeight: "semiBold",
              children: folder.name
            })
...
var AssetsTable = ({ assets, folders = [], mixedItems = null, renderedKeys, onAssetItemClick }) => {
  const isDesktop = useIsDesktop();
  const { formatMessage } = useIntl();
  ...
  return (0, import_jsx_runtime14.jsxs)(StyledTable, {
    colCount,
    rowCount: (mixedItems ? mixedItems.length : totalRows) + 1,
    children: [
      (0, import_jsx_runtime14.jsx)(StyledThead, {
        children: (0, import_jsx_runtime14.jsxs)(Ul, {
          children: [
            showCheckboxColumn && (0, import_jsx_runtime14.jsx)(CheckboxTh, {
              children: (0, import_jsx_runtime14.jsx)(C, {
                children: (0, import_jsx_runtime14.jsx)(Bt, {
            ...
            visibleHeaders.map((header) => {
              ...
              if (isVisuallyHidden) {
                return (0, import_jsx_runtime14.jsx)(StyledTh, {
                  $flex: header.name === "name",
                  children: (0, import_jsx_runtime14.jsx)($e, {
                    children: formatMessage({
      ...
      (0, import_jsx_runtime14.jsxs)(_l, {
        children: [
          mixedItems == null ? void 0 : mixedItems.map((item) => item.kind === "folder" ? (0, import_jsx_runtime14.jsx)(FolderRow, {
            folder: item.folder,
            orderedItemKeys
          }, `folder-${item.folder.id}`) : (0, import_jsx_runtime14.jsx)(AssetRow, {
            asset: item.asset,
            orderedItemKeys,
            onAssetItemClick
          }, item.asset.id)),
          !mixedItems && folders.map((folder) => (0, import_jsx_runtime14.jsx)(FolderRow, {
            folder,
            orderedItemKeys
          }, `folder-${folder.id}`)),
          !mixedItems && assets.map((asset) => (0, import_jsx_runtime14.jsx)(AssetRow, {
            asset,
            orderedItemKeys,
            onAssetItemClick
          }, asset.id))
...
`;
var BulkActionsBar = ({ assets = [], locations = emptyItemLocations, renderedKeys = [] }) => {
  const { formatMessage } = useIntl();
  const { toggleNotification } = useNotification();
  const isAiMetadataEnabled = useAIMetadataEnabled();
  const { canUpdate } = useMediaLibraryPermissions();
  const { selectedIds, selectedFolderIds, selectAll: selectAll2, clear } = useAssetSelection();
  const { trackUsage } = useTracking2();
  const { currentFolderId } = useFolderNavigation();
  ...
  const [isMoveDialogOpen, setIsMoveDialogOpen] = (0, import_react14.useState)(false);
  const [isDeleting, setIsDeleting] = (0, import_react14.useState)(false);
  const count = selectedIds.size + selectedFolderIds.size;
  const [barEl, setBarEl] = (0, import_react14.useState)(null);
  const [reservedSpace, setReservedSpace] = (0, import_react14.useState)(0);
  ...
  const handleSelectAll = () => {
    trackUsage("didSelectAllMediaLibraryElements");
    selectAll2(renderedKeys);
  };
  const isBusy = isDeleting || isGeneratingMetadata;
  const moveItems = (0, import_react14.useMemo)(() => buildDragSetFromSelection(selectedIds, selectedFolderIds, locations, currentFolderId), [
    selectedIds,
    selectedFolderIds,
    locations,
    currentFolderId
  ...
  const eligibleCount = (0, import_react14.useMemo)(() => {
  ...
  return (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, {
    children: [
      (0, import_jsx_runtime15.jsx)(S, {
        "aria-hidden": true,
        height: `${reservedSpace}px`,
        "data-bar-spacer": true
      }),
      (0, import_jsx_runtime15.jsxs)(Bar, {
        ref: setBarEl,
        ...
        children: [
          ...
          (0, import_jsx_runtime15.jsxs)(ActionCluster, {
            "data-bar-slot": "actions",
            children: [
              isAiMetadataEnabled && (0, import_jsx_runtime15.jsx)(Mt, {
                label: metadataDisabledReason,
                children: (0, import_jsx_runtime15.jsx)(S, {
                  children: (0, import_jsx_runtime15.jsx)(Ct, {
                    size: "S",
                    startIcon: (0, import_jsx_runtime15.jsx)(Vn, {}),
              ...
              (0, import_jsx_runtime15.jsx)(be, {
                ...
                children: (0, import_jsx_runtime15.jsx)(I2, {})
              }),
              (0, import_jsx_runtime15.jsx)(BulkMoveDialog, {
              ...
              (0, import_jsx_runtime15.jsx)(be, {
                ...
                children: (0, import_jsx_runtime15.jsx)(In, {})
              }),
              (0, import_jsx_runtime15.jsx)(DeleteItemsDialog, {
          ...
          (0, import_jsx_runtime15.jsx)(VerticalDivider, {
            "data-bar-slot": "divider",
            "aria-hidden": true
          }),
          (0, import_jsx_runtime15.jsx)(be, {
            ...
            onClick: clear,
            disabled: isBusy,
            children: (0, import_jsx_runtime15.jsx)(F5, {})
          })
        ]
      })
    ]
...
var UploadDropZoneContext = (0, import_react15.createContext)(null);
...
var UploadDropZoneProvider = ({ children, onDrop, disabled = false }) => {
  ...
  const dragCounterRef = (0, import_react15.useRef)(0);
  const contextValue = {
    isDragging
  };
  ...
  const handleDragEnter = (0, import_react15.useCallback)((e) => {
    e.preventDefault();
    e.stopPropagation();
    if (disabled) {
      return;
  ...
  return (0, import_jsx_runtime16.jsx)(UploadDropZoneContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime16.jsx)(DropZoneWrapper, {
...
var useUploadDropZone = () => {
  const context = (0, import_react15.useContext)(UploadDropZoneContext);
  if (!context) {
...
var DropZoneWithOverlay = ({ children }) => {
  ...
  return (0, import_jsx_runtime17.jsxs)(S, {
    position: "relative",
    children: [
      showOverlay && (0, import_jsx_runtime17.jsx)(DropZoneOverlay, {}),
      children
    ]
  });
};
...
var DropFilesMessage = ({ uploadDropZoneRef, folderName }) => {
  ...
  const [leftContentWidth, setLeftContentWidth] = React6.useState(0);
  React6.useEffect(() => {
  ...
  return (0, import_jsx_runtime17.jsxs)(DropFilesMessageImpl, {
    ...
    children: [
      ...
      (0, import_jsx_runtime17.jsxs)(C, {
        gap: 2,
        alignItems: "center",
        children: [
          (0, import_jsx_runtime17.jsx)(_5, {
            width: 20,
            height: 20,
            fill: "neutral0"
          }),
  ...
  return (0, import_jsx_runtime18.jsxs)(C, {
    ...
    children: [
      ...
      isSearchEmptyState ? (
        ...
        (0, import_jsx_runtime18.jsx)(Ct, {
          variant: "secondary",
          startIcon: (0, import_jsx_runtime18.jsx)(F5, {
            "aria-hidden": true
          }),
      ...
      ) : canAddAssets && (0, import_jsx_runtime18.jsx)(Ct, {
        onClick: onAddAssets,
        children: formatMessage({
...
var DateRangeCalendar = ({ from, to, onSelect }) => {
  ...
  const [viewYear, setViewYear] = (0, import_react16.useState)(initialMonth.getFullYear());
  const [viewMonth, setViewMonth] = (0, import_react16.useState)(initialMonth.getMonth());
  const [pendingStart, setPendingStart] = (0, import_react16.useState)(null);
        ...
        (0, import_jsx_runtime19.jsxs)(C, {
          ...
          children: [
            (0, import_jsx_runtime19.jsx)(be, {
              ...
              onClick: () => moveMonth(-1),
              children: (0, import_jsx_runtime19.jsx)(i5, {})
            }),
            ...
            (0, import_jsx_runtime19.jsx)(be, {
              ...
              onClick: () => moveMonth(1),
              children: (0, import_jsx_runtime19.jsx)(v5, {})
            })
          ]
        }),
        (0, import_jsx_runtime19.jsx)(C, {
          children: weekDayLabels.map((label, index) => (0, import_jsx_runtime19.jsx)(C, {
            width: "3rem",
            height: "2.4rem",
            justifyContent: "center",
...
var FilterMenu = ({ listFilters }) => {
  ...
  const isMobile = useIsMobile();
  const [openField, setOpenField] = (0, import_react17.useState)(null);
  const [rangeOpen, setRangeOpen] = (0, import_react17.useState)(false);
  ...
  const typeItems = TYPE_VALUES.map((value) => (0, import_jsx_runtime20.jsx)(gd.Item, {
    ...
    startIcon: (0, import_jsx_runtime20.jsx)(Bt, {
  ...
  const presetItems = (field) => {
    ...
    return DATE_PRESETS.map((preset) => (0, import_jsx_runtime20.jsx)(gd.Item, {
      role: "menuitemradio",
      "aria-checked": selected === preset,
      onSelect: () => {
        addPreset(field, preset);
      },
      endIcon: selected === preset ? (0, import_jsx_runtime20.jsx)(h5, {
        "aria-hidden": true,
        width: "1.6rem",
        height: "1.6rem",
        fill: "primary600"
  ...
  return (0, import_jsx_runtime20.jsxs)(gd.Root, {
    open: isOpen,
    onOpenChange: handleOpenChange,
    children: [
      (0, import_jsx_runtime20.jsx)(gd.Trigger, {
        variant: "tertiary",
        startIcon: (0, import_jsx_runtime20.jsx)(Y5, {
          "aria-hidden": true
        }),
        endIcon: null,
        children: (0, import_jsx_runtime20.jsxs)(C, {
          gap: 2,
          alignItems: "center",
          tag: "span",
          children: [
            ...
            filters.length > 0 && (0, import_jsx_runtime20.jsx)(CountBadge, {
              children: filters.length
            })
          ]
        })
      }),
      (0, import_jsx_runtime20.jsx)(gd.Content, {
        ...
        children: isMobile ? (
          ...
          (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, {
            children: [
              (0, import_jsx_runtime20.jsx)(FieldToggle, {
                "aria-expanded": openField === "type",
                onSelect: (e) => {
                  e.preventDefault();
                  toggleField("type");
                },
                endIcon: (0, import_jsx_runtime20.jsx)(Chevron, {
                  $open: openField === "type",
                  "aria-hidden": true
                }),
                children: typeLabel
              }),
              openField === "type" && (0, import_jsx_runtime20.jsx)(OptionGroup, {
                children: typeItems
              }),
              [
                "createdAt",
                "updatedAt"
              ].map((field) => (0, import_jsx_runtime20.jsxs)(S, {
                width: "100%",
                children: [
                  (0, import_jsx_runtime20.jsx)(FieldToggle, {
                  ...
                  openField === field && (0, import_jsx_runtime20.jsxs)(OptionGroup, {
                    children: [
                      presetItems(field),
                      field === "createdAt" && (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, {
                        children: [
                          (0, import_jsx_runtime20.jsx)(FieldToggle, {
                          ...
                          rangeOpen && (0, import_jsx_runtime20.jsx)(S, {
                            paddingLeft: 2,
                            children: (0, import_jsx_runtime20.jsx)(DateRangeCalendar, {
                              onSelect: addRange
                            })
                          })
                        ]
          ...
          children: [
            (0, import_jsx_runtime20.jsxs)(gd.SubRoot, {
              children: [
                (0, import_jsx_runtime20.jsx)(FieldSubTrigger, {
                  children: typeLabel
                }),
                (0, import_jsx_runtime20.jsx)(SubPanel, {
                  zIndex: 2,
                  maxHeight: PANEL_MAX_HEIGHT,
            ...
            [
              "createdAt",
              "updatedAt"
            ].map((field) => (0, import_jsx_runtime20.jsxs)(gd.SubRoot, {
              children: [
                (0, import_jsx_runtime20.jsx)(FieldSubTrigger, {
                  children: formatMessage(DATE_FIELD_LABELS[field])
                }),
                (0, import_jsx_runtime20.jsxs)(SubPanel, {
                  zIndex: 2,
                  maxHeight: PANEL_MAX_HEIGHT,
                  width: FILTER_PANEL_WIDTH,
                  children: [
                    presetItems(field),
                    field === "createdAt" && (0, import_jsx_runtime20.jsxs)(gd.SubRoot, {
                      children: [
                        (0, import_jsx_runtime20.jsx)(FieldSubTrigger, {
                          children: selectDateRangeLabel
                        }),
...
var SegmentPopover = ({ label, options, active, getOptionLabel, onPick }) => {
  ...
  return (0, import_jsx_runtime21.jsxs)(Xd.Root, {
    open,
    onOpenChange: setOpen,
    children: [
      (0, import_jsx_runtime21.jsx)(Xd.Trigger, {
        children: (0, import_jsx_runtime21.jsx)(Segment, {
          type: "button",
          $interactive: true,
      ...
      (0, import_jsx_runtime21.jsx)(PanelPopoverContent, {
        children: (0, import_jsx_runtime21.jsx)(C, {
          direction: "column",
          alignItems: "stretch",
          padding: 1,
          children: options.map((option) => (0, import_jsx_runtime21.jsxs)(OptionButton, {
            type: "button",
            onClick: () => {
              onPick(option);
              setOpen(false);
            ...
            children: [
              ...
              option === active && (0, import_jsx_runtime21.jsx)(h5, {
                "aria-hidden": true,
                width: "1.6rem",
                height: "1.6rem"
              })
    ...
    children: [
      ...
      (0, import_jsx_runtime21.jsx)(PanelPopoverContent, {
        children: (0, import_jsx_runtime21.jsx)(C, {
          ...
          padding: 3,
          gap: 2,
          children: TYPE_VALUES.map((value) => (0, import_jsx_runtime21.jsx)(Bt, {
...
var DateValuePopover = ({ filter, onChange }) => {
  ...
  return (0, import_jsx_runtime21.jsxs)(Xd.Root, {
    ...
    children: [
      ...
      (0, import_jsx_runtime21.jsx)(PanelPopoverContent, {
        children: filter.mode === "preset" ? (0, import_jsx_runtime21.jsx)(C, {
          direction: "column",
          alignItems: "stretch",
          padding: 1,
          children: DATE_PRESETS.map((preset) => (0, import_jsx_runtime21.jsxs)(OptionButton, {
            type: "button",
            onClick: () => {
              onChange({
                ...filter,
            ...
            children: [
              ...
              preset === filter.preset && (0, import_jsx_runtime21.jsx)(h5, {
                "aria-hidden": true,
                width: "1.6rem",
                height: "1.6rem"
              })
        ...
        }) : (0, import_jsx_runtime21.jsx)(DateRangeCalendar, {
          from: filter.from,
          to: filter.to,
          onSelect: (from, to) => {
            onChange({
...
var FilterBadge = ({ filter, onChange, onRemove }) => {
  ...
  return (0, import_jsx_runtime21.jsxs)(BadgePill, {
    alignItems: "stretch",
    "data-testid": "filter-badge",
    children: [
      (0, import_jsx_runtime21.jsx)(FieldSegment, {
        children: (0, import_jsx_runtime21.jsx)(A, {
          variant: "pi",
          textColor: "neutral600",
          children: fieldLabel
      ...
      filter.kind === "type" && (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, {
        children: [
          (0, import_jsx_runtime21.jsx)(SegmentPopover, {
          ...
          (0, import_jsx_runtime21.jsx)(TypeValuePopover, {
            filter,
            onChange
          })
        ]
      }),
      filter.kind === "date" && filter.mode === "preset" && (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, {
        children: [
          (0, import_jsx_runtime21.jsx)(SegmentPopover, {
          ...
          (0, import_jsx_runtime21.jsx)(DateValuePopover, {
            filter,
            onChange
          })
        ]
      }),
      filter.kind === "date" && filter.mode === "range" && (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, {
        children: [
          (0, import_jsx_runtime21.jsx)(SegmentPopover, {
      ...
      (0, import_jsx_runtime21.jsx)(RemoveButton, {
        type: "button",
        onClick: onRemove,
        "aria-label": formatMessage({
...
var FilterBadges = ({ listFilters, compact = false }) => {
  ...
  return (0, import_jsx_runtime21.jsx)(BadgesRoot, {
    $compact: compact,
    gap: 2,
    wrap: "wrap",
    "data-testid": "filter-badges",
    children: filters.map((filter, index) => (0, import_jsx_runtime21.jsx)(FilterBadge, {
      filter,
...
var useExpandedFolders = (folderStructure, currentFolderId) => {
  ...
  const toggleExpanded = (0, import_react20.useCallback)((id) => {
    setExpandedIds((prev) => {
      const next = new Set(prev);
      if (next.has(id)) {
        next.delete(id);
  ...
  const expandFolder = (0, import_react20.useCallback)((id) => {
    setExpandedIds((prev) => {
      if (prev.has(id)) {
        return prev;
      }
  ...
  const isExpanded = (0, import_react20.useCallback)((id) => expandedIds.has(id), [
    expandedIds
  ]);
  return {
    isExpanded,
...
var FolderTreeItemInner = ({ id, name, folderChildren, level, currentFolderId, showActiveFolder, isExpanded, onToggle, onExpand, onSelect, isMovePending }) => {
  ...
  const handleExpand = (0, import_react20.useCallback)(() => onExpand(id), [
    id,
    onExpand
  ]);
  ...
  return (0, import_jsx_runtime22.jsxs)("li", {
    children: [
      (0, import_jsx_runtime22.jsxs)(TreeRow, {
        ref: setNodeRef,
        alignItems: "center",
        ...
        $isMovePending: isMovePending,
        children: [
          (0, import_jsx_runtime22.jsx)(ChevronButton, {
            ...
            variant: "ghost",
            withTooltip: false,
            "aria-expanded": hasChildren ? isFolderExpanded : void 0,
            children: (0, import_jsx_runtime22.jsx)(RotatingChevron, {
              $expanded: isFolderExpanded,
              fill: "neutral500"
            })
          }),
          (0, import_jsx_runtime22.jsx)(S, {
            flex: "1",
            minWidth: 0,
            children: (0, import_jsx_runtime22.jsx)(RowButton, {
              type: "button",
              $isActive: isActive,
              $isValidDropTarget: showValidDropHighlight,
              $isInvalidDropCursor: showInvalidDropCursor,
              ...
              "data-folder-id": id,
              children: (0, import_jsx_runtime22.jsx)(TruncatedText, {
                variant: "omega",
      ...
      hasChildren && isFolderExpanded && (0, import_jsx_runtime22.jsx)(NavList, {
        children: folderChildren.map((child) => (0, import_jsx_runtime22.jsx)(FolderTreeItem, {
          node: child,
          level: level + 1,
          currentFolderId,
          showActiveFolder,
...
var FolderTreeItem = ({ node, ...props }) => {
  ...
  return (0, import_jsx_runtime22.jsx)(FolderTreeItemInner, {
    ...props,
    id: node.id,
    name: node.name ?? "",
...
var FolderTree = ({ currentFolderId, showActiveFolder = true, onSelectFolder }) => {
  ...
  return (0, import_jsx_runtime22.jsxs)(SubNav.Main, {
    "aria-label": formatMessage({
      id: getTranslationKey("sidebar.tree.aria-label"),
      defaultMessage: "Media library folders"
    }),
    children: [
      (0, import_jsx_runtime22.jsx)(SubNav.Header, {
        label: formatMessage({
          id: getTranslationKey("sidebar.title"),
          defaultMessage: "Media library"
        })
      }),
      (0, import_jsx_runtime22.jsx)(SubNav.Content, {
        children: (0, import_jsx_runtime22.jsxs)(C, {
          ...
          padding: 3,
          children: [
            (0, import_jsx_runtime22.jsxs)(RowButton, {
              ref: setHomeDropRef,
              type: "button",
            ...
            (0, import_jsx_runtime22.jsxs)(S, {
              ...
              children: [
                ...
                isLoading ? (
                  ...
                  (0, import_jsx_runtime22.jsx)(C, {
                    justifyContent: "center",
                    padding: 1,
                    paddingTop: 2,
                    children: (0, import_jsx_runtime22.jsx)(kt, {
                      children: formatMessage({
                ...
                ) : (0, import_jsx_runtime22.jsx)(NavList, {
                  children: folderStructure.map((node) => (0, import_jsx_runtime22.jsx)(FolderTreeItem, {
                    node,
                    level: 0,
                    currentFolderId,
                    showActiveFolder,
...
var ImportFromUrlDialog = ({ open, onClose, onUpload }) => {
  const { formatMessage } = useIntl();
  const [urls, setUrls] = React7.useState("");
  ...
  return (0, import_jsx_runtime23.jsx)(_d.Root, {
    open,
    onOpenChange: (isOpen) => !isOpen && handleClose(),
    children: (0, import_jsx_runtime23.jsx)(_d.Content, {
      children: (0, import_jsx_runtime23.jsxs)("form", {
        onSubmit: handleSubmit,
        children: [
          (0, import_jsx_runtime23.jsx)(_d.Header, {
            children: (0, import_jsx_runtime23.jsx)(_d.Title, {
              children: formatMessage({
          ...
          (0, import_jsx_runtime23.jsx)(_d.Body, {
            children: (0, import_jsx_runtime23.jsxs)(Dd.Root, {
              error: error || void 0,
              hint: formatMessage({
              ...
              children: [
                (0, import_jsx_runtime23.jsx)(Dd.Label, {
                  children: formatMessage({
                    id: getTranslationKey("input.url.label"),
                    defaultMessage: "URL(s)"
                  })
                }),
                (0, import_jsx_runtime23.jsx)($u, {
                  name: "urls",
                  minHeight: "unset",
                ...
                (0, import_jsx_runtime23.jsx)(Dd.Hint, {}),
                (0, import_jsx_runtime23.jsx)(Dd.Error, {})
              ]
            })
          }),
          (0, import_jsx_runtime23.jsxs)(_d.Footer, {
            children: [
              (0, import_jsx_runtime23.jsx)(Ct, {
                variant: "tertiary",
                onClick: handleClose,
                children: formatMessage({
                  id: "app.components.Button.cancel",
...
// node_modules/@strapi/upload/dist/admin/future/pages/Assets/components/MainAreaContextMenu.mjs
var import_jsx_runtime24 = __toESM(require_jsx_runtime(), 1);
var import_react21 = __toESM(require_react(), 1);
var SCROLL_ROOT_SELECTOR = "[data-strapi-main-content]";
...
var MainAreaContextMenu = ({ onCreateFolder, onImportFiles, onImportFromUrl, disabled }) => {
  const { formatMessage } = useIntl();
  const [position, setPosition] = (0, import_react21.useState)(null);
  const [locator, setLocator] = (0, import_react21.useState)(null);
  const anchorRef = (0, import_react21.useCallback)((node) => setLocator(node), []);
  (0, import_react21.useEffect)(() => {
    const container = locator == null ? void 0 : locator.closest(SCROLL_ROOT_SELECTOR);
  ...
  return (0, import_jsx_runtime24.jsxs)(import_jsx_runtime24.Fragment, {
    children: [
      ...
      !disabled && (0, import_jsx_runtime24.jsxs)(gd.Root, {
        modal: false,
        open: position !== null,
        onOpenChange: (open) => {
          if (!open) {
        ...
        children: [
          (0, import_jsx_runtime24.jsx)(gd.Trigger, {
            tabIndex: -1,
            ...
            style: {
              ...CURSOR_ANCHOR_STYLE,
              top: (position == null ? void 0 : position.y) ?? 0,
              left: (position == null ? void 0 : position.x) ?? 0
            }
          }),
          (0, import_jsx_runtime24.jsxs)(ActionsMenuContent, {
            popoverPlacement: "bottom-start",
            zIndex: 2,
            minWidth: "22rem",
            ...
            children: [
              (0, import_jsx_runtime24.jsx)(gd.Item, {
                onSelect: onCreateFolder,
                startIcon: (0, import_jsx_runtime24.jsx)(_5, {}),
                children: formatMessage({
              ...
              (0, import_jsx_runtime24.jsx)(gd.Item, {
                ...
                startIcon: (0, import_jsx_runtime24.jsx)(J5, {}),
                children: formatMessage({
              ...
              (0, import_jsx_runtime24.jsx)(gd.Item, {
                ...
                startIcon: (0, import_jsx_runtime24.jsx)(R3, {}),
                children: formatMessage({
...
// node_modules/@strapi/upload/dist/admin/future/pages/Assets/utils/mergeUploadedAssets.mjs
var SORT_FIELDS = [
  "createdAt",
  "updatedAt",
  "name",
...
var isSortField = (value) => SORT_FIELDS.includes(value);
var DEFAULT_RULE = "updatedAt:DESC";
var compareByField = (field, a, b) => {
  if (field === "size") {
...
var getAssetComparator = (rule = DEFAULT_RULE) => {
...
var mergeUploadedAssets = ({ assets, uploaded, sort, hasNextPage }) => {
...
var deepestPage = (pages) => Object.keys(pages).reduce((deepest, key) => Math.max(deepest, Number(key)), 1);
...
var useInfiniteAssets = ({ folder = null, sort, search, filters, enabled = true } = {}) => {
  ...
  const memoryRef = (0, import_react22.useRef)(/* @__PURE__ */ new Map());
  const isNewList = pageState.queryKey !== queryKey;
  const remembered = isNewList ? memoryRef.current.get(queryKey) : void 0;
  let page;
  if (!isNewList) {
    page = pageState.page;
  } else if (remembered) {
  ...
  const loadedAssets = (0, import_react22.useMemo)(() => isChangingList ? [] : flattenPages(accumulated.pages), [
    isChangingList,
    accumulated.pages
  ]);
  ...
  const canPlaceUploads = !search && ((filters == null ? void 0 : filters.length) ?? 0) === 0;
  const listAnsweredAfter = fulfilledTimeStamp !== void 0 && startedTimeStamp !== void 0 && // A refetch in flight leaves `fulfilledTimeStamp` on the previous response,
  // which predates this request — so only settled data counts.
  fulfilledTimeStamp > startedTimeStamp ? startedTimeStamp : void 0;
  const assets = (0, import_react22.useMemo)(() => {
    if (!canPlaceUploads || completedUploads.length === 0) {
      return loadedAssets;
    }
    const bridging = completedUploads.filter(({ asset, completedAt }) => getRelationId(asset.folder) === folder && (listAnsweredAfter === void 0 || completedAt > listAnsweredAfter));
...
// node_modules/@strapi/upload/dist/admin/future/pages/Assets/hooks/useListScrollRestoration.mjs
var import_react24 = __toESM(require_react(), 1);
var SCROLL_ROOT_SELECTOR2 = "[data-strapi-main-content]";
var RESTORE_WINDOW_MS = 2e3;
var MAX_REMEMBERED_OFFSETS = 10;
var useListScrollRestoration = (key) => {
  const offsetsRef = (0, import_react24.useRef)(/* @__PURE__ */ new Map());
  const containerRef = (0, import_react24.useRef)(null);
  const detachRef = (0, import_react24.useRef)(null);
  const keyRef = (0, import_react24.useRef)(key);
  const pendingRef = (0, import_react24.useRef)(null);
  const anchorRef = (0, import_react24.useCallback)((node) => {
    var _a;
    (_a = detachRef.current) == null ? void 0 : _a.call(detachRef);
    detachRef.current = null;
    containerRef.current = null;
    const container = node == null ? void 0 : node.closest(SCROLL_ROOT_SELECTOR2);
    if (!container) {
      return;
    }
    const handleScroll = () => {
  ...
  (0, import_react24.useEffect)(() => () => {
    var _a;
    return (_a = detachRef.current) == null ? void 0 : _a.call(detachRef);
  }, []);
...
var AssetsView = ({ view, folders, isLoadingFolders, assets, isLoadingAssets, isFetchingMore, hasNextPage, fetchNextPage, error, locations, searchQuery, assetsSort, foldersPosition, hasActiveFilters, onClearFilters, onAssetItemClick, onAddAssets, canAddAssets, onClearSearch }) => {
  ...
  const mixedItems = (0, import_react25.useMemo)(() => foldersPosition === "mixed" && !isGridView ? mergeMixedList({
    folders,
    assets,
    sort: assetsSort,
    hasNextPage
  ...
  const renderedKeys = buildRenderedKeys({
    folders,
    assets,
    mixedItems
  });
...
var AssetsPage = () => {
  ...
  const builtFilters = (0, import_react25.useMemo)(
  ...
  const folders = (0, import_react25.useMemo)(() => builtFilters.showFolders ? fetchedFolders : [], [
    builtFilters.showFolders,
    fetchedFolders
  ]);
  const itemLocations = (0, import_react25.useMemo)(() => buildItemLocations(assets, folders), [
    assets,
    folders
  ]);
  ...
  const [isCreateFolderDialogOpen, setIsCreateFolderDialogOpen] = (0, import_react25.useState)(false);
  const [view, setView] = usePersistentState(localStorageKeys.view, viewOptions.GRID);
  const isGridView = view === viewOptions.GRID;
  const [isUrlDialogOpen, setIsUrlDialogOpen] = (0, import_react25.useState)(false);
  const fileInputRef = (0, import_react25.useRef)(null);
  const uploadDropZoneRef = (0, import_react25.useRef)(null);
  const [isHeaderCompact, setIsHeaderCompact] = (0, import_react25.useState)(false);
  const onHeaderSentinelVisibility = (0, import_react25.useCallback)((isVisible) => setIsHeaderCompact(!isVisible), []);
                  ...
                  children: (0, import_jsx_runtime26.jsx)(Page.Main, {
                    children: (0, import_jsx_runtime26.jsxs)(S, {
                      ...
                      children: [
                        ...
                        (0, import_jsx_runtime26.jsx)(MainAreaContextMenu, {
                          disabled: !canCreate,
...
//# sourceMappingURL=App-LXJJO3KL.js.map
