...
var DateTimeInput = (0, import_react4.forwardRef)(({ name, required, label, hint, labelAction, type: _type, ...props }, ref) => {
  const { formatMessage } = useIntl();
  const field = useField(name);
  const fieldRef = useFocusInputField(name);
  const composedRefs = te(ref, fieldRef);
...
var TimeInput = (0, import_react11.forwardRef)(({ name, required, label, hint, labelAction, type: _type, ...props }, ref) => {
  const { formatMessage } = useIntl();
  const field = useField(name);
  const fieldRef = useFocusInputField(name);
  const composedRefs = te(ref, fieldRef);
...
//# sourceMappingURL=chunk-XXHDYA22.js.map
