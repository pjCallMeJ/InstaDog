...
var selectReportsByteProgress = createSelector((state) => state.uploadProgress.reportsByteProgress, (reportsByteProgress) => reportsByteProgress);
...
`;
var keepOpen = (event) => event.preventDefault();
var DrawerBody = React.forwardRef(({ animationDirection, width, maxHeight, onPointerDownOutside = keepOpen, children, ...props }, ref) => (0, import_jsx_runtime.jsx)($5d3850c4d0b4e6c7$export$7c6e2c02157bb7d2, {
  ref,
  forceMount: true,
  asChild: true,
...
//# sourceMappingURL=chunk-JZU7J36O.js.map
