...
// node_modules/@strapi/admin/dist/admin/admin/src/utils/unsavedChangesRegistry.mjs
var checks = /* @__PURE__ */ new Map();
var registerUnsavedChangesCheck = (id, check) => {
  checks.set(id, check);
  return () => {
    checks.delete(id);
  };
...
scheduler/cjs/scheduler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-C7P74TZF.js.map
