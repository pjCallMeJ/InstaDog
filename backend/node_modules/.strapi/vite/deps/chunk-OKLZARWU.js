...
// node_modules/@strapi/content-type-builder/dist/admin/utils/applyPrivateSearchDefault.mjs
var SEARCHABLE_ATTRIBUTE_TYPES = /* @__PURE__ */ new Set([
  "string",
  "text",
  "uid",
  "email",
...
var applyPrivateSearchDefault = (attribute) => {
  if (attribute.private === true && attribute.searchable === void 0 && typeof attribute.type === "string" && SEARCHABLE_ATTRIBUTE_TYPES.has(attribute.type)) {
    return {
      ...attribute,
      searchable: false
    };
...
//# sourceMappingURL=chunk-OKLZARWU.js.map
