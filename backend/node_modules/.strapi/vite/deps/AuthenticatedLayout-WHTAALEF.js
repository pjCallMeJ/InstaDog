...
var package_default = {
  ...
  dependencies: {
    ...
    "@strapi/types": "5.54.0",
    "@strapi/typescript-utils": "5.54.0",
    "@strapi/utils": "5.54.0",
  ...
  devDependencies: {
    "@strapi/admin-test-utils": "5.54.0",
    "@strapi/data-transfer": "5.54.0",
...
// node_modules/@strapi/admin/dist/admin/admin/src/components/MediaLibraryBanner.mjs
var import_jsx_runtime21 = __toESM(require_jsx_runtime(), 1);

// node_modules/@strapi/admin/dist/admin/admin/src/components/DismissibleBanner.mjs
...
`;
var DismissibleBanner = ({ message, action, closeLabel, onDismiss }) => {
  return (0, import_jsx_runtime20.jsx)(BannerBackground, {
    width: "100%",
    justifyContent: "center",
    children: (0, import_jsx_runtime20.jsxs)(C, {
      ...
      children: [
        (0, import_jsx_runtime20.jsxs)(C, {
          ...
          flex: 1,
          children: [
            (0, import_jsx_runtime20.jsx)(S, {
              children: message
            }),
            action ? (0, import_jsx_runtime20.jsx)(S, {
              children: action
            }) : null
          ]
        }),
        (0, import_jsx_runtime20.jsx)(S, {
          shrink: 0,
          children: (0, import_jsx_runtime20.jsx)(be, {
            withTooltip: false,
            label: closeLabel,
            onClick: onDismiss,
            children: (0, import_jsx_runtime20.jsx)(F5, {})
          })
        })
      ]
    })
...
// node_modules/@strapi/admin/dist/admin/admin/src/components/MediaLibraryBanner.mjs
var Banner = ({ isLegacyMediaLibrary, onDismiss }) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime21.jsx)(DismissibleBanner, {
    onDismiss,
    closeLabel: formatMessage({
      id: "app.components.MediaLibraryBanner.close",
      defaultMessage: "Close"
    }),
    message: (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, {
      children: [
        ...
        (0, import_jsx_runtime21.jsx)(A, {
          ...
          paddingRight: 4,
          fontSize: 2,
          children: formatMessage(isLegacyMediaLibrary ? {
            id: "app.components.MediaLibraryBanner.text",
            defaultMessage: "Check the documentation to learn how to switch to the new one."
          } : {
    ...
    action: isLegacyMediaLibrary ? (0, import_jsx_runtime21.jsx)(Hd, {
      width: "max-content",
      variant: "tertiary",
      startIcon: (0, import_jsx_runtime21.jsx)(E5, {}),
...
var MediaLibraryBanner = () => {
  const isLegacyMediaLibrary = window.strapi.featureFlags.isEnabled("useLegacyMediaLibrary");
  const [isDismissed, setIsDismissed] = useScopedPersistentState(`STRAPI_MEDIA_LIBRARY_BANNER_DISMISSED_FOR_${isLegacyMediaLibrary}`, false);
  if (isDismissed) {
    return null;
  }
  ...
  if (hasApluginNotReady) {
    const initializers = Object.keys(plugins).reduce((acc, current) => {
      ...
      if (InitializerComponent) {
        ...
        acc.push((0, import_jsx_runtime22.jsx)(InitializerComponent, {
    ...
    return (0, import_jsx_runtime22.jsxs)(import_jsx_runtime22.Fragment, {
      children: [
        initializers,
        (0, import_jsx_runtime22.jsx)(Page.Loading, {})
      ]
    });
  }
  return children;
...
var FixedButtonWrapper = gt(S)`
  ...
  right: 16px;
`;
var Banner2 = ({ isTrialEndedRecently, onDismiss }) => {
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime23.jsx)(DismissibleBanner, {
    onDismiss,
    closeLabel: formatMessage({
      id: "app.components.UpsellBanner.close",
      defaultMessage: "Close"
    }),
    message: (0, import_jsx_runtime23.jsxs)(import_jsx_runtime23.Fragment, {
      children: [
    ...
    action: (0, import_jsx_runtime23.jsx)(Hd, {
      width: "max-content",
      variant: "tertiary",
...
var UpsellBanner = () => {
  ...
  if (isDismissed) {
    return (0, import_jsx_runtime23.jsx)(FixedButtonWrapper, {
      children: (0, import_jsx_runtime23.jsx)(be, {
        withTooltip: false,
        label: formatMessage({
        ...
        children: (0, import_jsx_runtime23.jsx)(Q2, {})
      })
    });
  }
  return (0, import_jsx_runtime23.jsx)(Banner2, {
...
var AdminLayout = () => {
  ...
  if (isLoadingMenu || isLoadingAppInfo) {
    return (0, import_jsx_runtime24.jsx)(Page.Loading, {});
  }
  return (0, import_jsx_runtime24.jsxs)(AppInfoProvider, {
    ...appInfo,
    userId,
    latestStrapiReleaseTag: tagName,
    shouldUpdateStrapi: checkLatestStrapiVersion(strapiVersion, tagName),
    children: [
      (0, import_jsx_runtime24.jsx)(NpsSurvey, {}),
      (0, import_jsx_runtime24.jsx)(PluginsInitializer, {
        children: (0, import_jsx_runtime24.jsx)(DndProvider, {
          backend: HTML5Backend,
          children: (0, import_jsx_runtime24.jsxs)(S, {
            background: "neutral100",
            children: [
              (0, import_jsx_runtime24.jsx)(jd, {
                children: formatMessage({
                  id: "skipToContent",
              ...
              (0, import_jsx_runtime24.jsxs)(C, {
                ...
                alignItems: "flex-start",
                children: [
                  (0, import_jsx_runtime24.jsx)(LeftMenu, {
                    generalSectionLinks,
                    pluginsSectionLinks,
                    topMobileNavigation,
                    burgerMobileNavigation
                  ...
                  (0, import_jsx_runtime24.jsxs)(C, {
                    ...
                    children: [
                      (0, import_jsx_runtime24.jsx)(UpsellBanner, {}),
                      (0, import_jsx_runtime24.jsx)(MediaLibraryBanner, {}),
                      (0, import_jsx_runtime24.jsx)(LazyOutlet, {
                        suspenseOnly: true
                      })
                    ]
                  })
...
var PrivateAdminLayout = () => {
  return (0, import_jsx_runtime24.jsx)(PrivateRoute, {
    children: (0, import_jsx_runtime24.jsx)(AdminLayout, {})
  });
};
...
//# sourceMappingURL=AuthenticatedLayout-WHTAALEF.js.map
