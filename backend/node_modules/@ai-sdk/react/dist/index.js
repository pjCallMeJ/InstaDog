...
function useChat({
  ...
  const getTransport = () => {
    var _a;
    return (_a = latestRef.current.transport) != null ? _a : defaultTransport != null ? defaultTransport : defaultTransport = new import_ai2.DefaultChatTransport();
  };
  const chatOptions = {
    ...options,
    transport: {
  ...
  const getMessagesSnapshot = (0, import_react.useCallback)(
  ...
  const subscribeToStatus = (0, import_react.useCallback)(
