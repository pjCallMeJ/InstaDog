...
var _metadata = /*#__PURE__*/ _class_private_field_loose_key("_metadata"), _schema = /*#__PURE__*/ _class_private_field_loose_key("_schema"), _handlers = /*#__PURE__*/ _class_private_field_loose_key("_handlers"), _currentStreamController = /*#__PURE__*/ _class_private_field_loose_key("_currentStreamController"), _aborted = /*#__PURE__*/ _class_private_field_loose_key("_aborted"), _closed = /*#__PURE__*/ _class_private_field_loose_key("_closed"), /**
   ...
   */ _assertSchemasMatching = /*#__PURE__*/ _class_private_field_loose_key("_assertSchemasMatching"), _transferStage = /*#__PURE__*/ _class_private_field_loose_key("_transferStage"), _closeAfterError = /*#__PURE__*/ _class_private_field_loose_key("_closeAfterError"), _resolveProviderResource = /*#__PURE__*/ _class_private_field_loose_key("_resolveProviderResource"), _getSchemas = /*#__PURE__*/ _class_private_field_loose_key("_getSchemas"), _mergeSourceStageTotals = /*#__PURE__*/ _class_private_field_loose_key("_mergeSourceStageTotals");
class TransferEngine {
   ...
   */ async close() {
        _class_private_field_loose_base(this, _closed)[_closed] = true;
        const results = await Promise.allSettled([
    ...
    async transfer() {
        ...
        this.progress.data = {};
        _class_private_field_loose_base(this, _closed)[_closed] = false;
        try {
            ...
            if (!_class_private_field_loose_base(this, _closed)[_closed]) {
                try {
                    await this.destinationProvider.rollback?.(e);
                } catch (rollbackError) {
                    const { message } = rollbackError instanceof Error ? rollbackError : {
                        message: ''
                    };
                    this.reportWarning(`Failed to rollback the ${this.destinationProvider.name} provider${message ? `: ${message}` : ''}`, 'transfer(rollback)');
                }
            }
            ...
            await _class_private_field_loose_base(this, _closeAfterError)[_closeAfterError]();
            throw e;
        }
        return {
   ...
   */ Object.defineProperty(this, _closeAfterError, {
            value: closeAfterError
        });
...
async function closeAfterError() {
    if (_class_private_field_loose_base(this, _closed)[_closed]) {
        return;
    }
    _class_private_field_loose_base(this, _closed)[_closed] = true;
    ...
    results.forEach((result, index)=>{
        if (result.status === 'rejected') {
            const { message } = result.reason instanceof Error ? result.reason : {
                message: ''
            };
            this.reportWarning(`Failed to close the ${providers[index].name} provider${message ? `: ${message}` : ''}`, 'transfer(cleanup)');
        }
    });
}
