...
const validateAssetMetadata = (metadata, filename)=>{
    ...
    if (invalidFields.length > 0) {
        throw new TypeError(`Asset sidecar metadata has invalid required fields: ${invalidFields.join(', ')}`);
    }
...
export { isFilePathInDirname, isPathEquivalent, unknownPathToPosix, validateAssetMetadata };
