...
var applyPrivateSearchDefault = require('../../utils/applyPrivateSearchDefault.js');
...
const createAttribute = (properties)=>{
    return {
        ...applyPrivateSearchDefault.applyPrivateSearchDefault(properties),
        status: 'NEW'
    };
};
const setAttributeAt = (type, index, attribute)=>{
    ...
    type.attributes[index] = {
        ...applyPrivateSearchDefault.applyPrivateSearchDefault(attribute),
        status: newStatus
    };
