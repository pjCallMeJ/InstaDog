...
import { useSessionKeepalive } from '../hooks/useSessionKeepalive.mjs';
...
import { getFetchClient, attemptTokenRefresh, setOnSessionExpired, resetSessionExpiredNotification, setOnTokenUpdate } from '../utils/getFetchClient.mjs';
import { hasUnsavedChanges } from '../utils/unsavedChangesRegistry.mjs';
...
const AuthProvider = ({ children, _defaultPermissions = [], _disableRenewToken = false })=>{
    ...
    const pendingLogoutRef = React.useRef(null);
    const logoutGuardOpenRef = React.useRef(false);
    const logoutGuardReasonRef = React.useRef('voluntary');
    const [isSessionLogoutDialogOpen, setIsSessionLogoutDialogOpen] = React.useState(false);
    const [sessionLogoutReason, setSessionLogoutReason] = React.useState('voluntary');
    /**
   ...
   */ const runLogoutWithGuard = React.useCallback((logoutFn, reason = 'voluntary')=>{
    ...
    const handleSessionLogoutDialogOpenChange = React.useCallback((open)=>{
        if (!open) {
        ...
        children: [
            ...
            /*#__PURE__*/ jsx(Dialog.Root, {
                ...
                children: /*#__PURE__*/ jsx(ConfirmDialog, {
                    ...
                    startAction: isForcedLogout(sessionLogoutReason) ? /*#__PURE__*/ jsx(Fragment, {}) : undefined,
