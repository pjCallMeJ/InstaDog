...
var useRegisterUnsavedChanges = require('../hooks/useRegisterUnsavedChanges.js');
 ...
 * -----------------------------------------------------------------------------------------------*/ const Blocker = ({ onProceed = ()=>{}, onCancel = ()=>{} })=>{
    ...
    const registrationId = React__namespace.useId();
   ...
   */ useRegisterUnsavedChanges.useRegisterUnsavedChanges(registrationId, modified);
    ...
    useWarnIfUnsavedChanges.useWarnIfUnsavedChanges(hasUnsavedEdits);
    const blocker = reactRouterDom.useBlocker(({ currentLocation, nextLocation })=>{
        return hasUnsavedEdits && (currentLocation.pathname !== nextLocation.pathname || currentLocation.search !== nextLocation.search);
    });
