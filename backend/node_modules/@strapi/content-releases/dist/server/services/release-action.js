...
const createReleaseActionService = ({ strapi })=>{
    ...
    return {
        async create (releaseId, action, { disableUpdateReleaseStatus = false } = {}) {
            ...
            await auditLogs.emitAuditOnCommit({
                strapi
            }, constants.AUDITED_EVENTS.RELEASE_ENTRY_ADD, {
        ...
        async update (actionId, releaseId, update) {
            ...
            if (updatedAction && action.type !== updatedAction.type) {
                await auditLogs.emitAuditOnCommit({
                    strapi
                }, constants.AUDITED_EVENTS.RELEASE_ENTRY_UPDATE, {
        ...
        async delete (actionId, releaseId) {
            const deletedRow = await strapi.db.query(constants.RELEASE_ACTION_MODEL_UID).delete({
                where: {
                    id: actionId,
                    release: {
                        id: releaseId,
            ...
            await auditLogs.emitAuditOnCommit({
                strapi
            }, constants.AUDITED_EVENTS.RELEASE_ENTRY_REMOVE, {
