...
const BlocksEditor = /*#__PURE__*/ React.forwardRef(({ disabled = false, name, onChange, value, error, livePreviewSync = false, blockIndex, ...contentProps }, forwardedRef)=>{
    ...
    React.useEffect(()=>{
        ...
        const raf = requestAnimationFrame(()=>{
            try {
                const blockNode = Node.get(editor, [
                    targetIndex
                ]);
                const domEl = ReactEditor.toDOMNode(editor, blockNode);
