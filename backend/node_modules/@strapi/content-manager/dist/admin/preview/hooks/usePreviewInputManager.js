...
function usePreviewInputManager(name, attribute) {
    ...
    const isSubmitting = strapiAdmin.useForm('usePreviewInputManager', (state)=>state.isSubmitting);
    const wasSubmittingRef = React__namespace.useRef(isSubmitting);
     ...
     */ if ([
        ...
        sendMessage(constants.PUBLIC_EVENTS.STRAPI_FIELD_CHANGE, {
            field: name,
            value,
            type
        });
