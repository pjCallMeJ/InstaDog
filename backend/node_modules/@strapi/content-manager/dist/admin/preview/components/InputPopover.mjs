...
import { Popover, Box, Flex } from '@strapi/design-system';
...
function usePreviewPopoverBlockIndex() {
    const blockIndex = useInputPopoverContext('usePreviewPopoverBlockIndex', (ctx)=>ctx.blockIndex, false);
 ...
 * -----------------------------------------------------------------------------------------------*/ const InputPopover = ({ documentResponse })=>{
     ...
     */ const handleMessage = (event)=>{
         ...
         */ if (fieldMetaData.documentId !== document.documentId) {
                ...
                try {
                    ...
                    const resolvedBlockIndex = typeof event.data.payload.blockIndex === 'number' && event.data.payload.blockIndex >= 0 ? event.data.payload.blockIndex : null;
                    setPopoverField({
                        ...fieldMetaData,
    ...
    return /*#__PURE__*/ jsx(Fragment, {
        children: /*#__PURE__*/ jsx(InputPopoverProvider, {
            blockIndex: popoverField.blockIndex,
