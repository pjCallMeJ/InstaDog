...
import { mediaListAssetsInputSchema, mediaGetAssetInputSchema, mediaUpdateAssetInputSchema, mediaMoveAssetsInputSchema, mediaDeleteAssetsInputSchema, mediaCreateFolderInputSchema, mediaRenameFolderInputSchema, mediaMoveFolderInputSchema, mediaDeleteFolderInputSchema } from './schemas/input-schemas.mjs';
import { mediaListAssetsOutputSchema, mediaGetAssetOutputSchema, mediaListFoldersOutputSchema, mediaUpdateAssetOutputSchema, mediaMoveAssetsOutputSchema, mediaDeleteAssetsOutputSchema, mediaCreateFolderOutputSchema, mediaRenameFolderOutputSchema, mediaMoveFolderOutputSchema, mediaDeleteFolderOutputSchema } from './schemas/output-schemas.mjs';
import { createMediaListAssetsHandler, createMediaGetAssetHandler, createMediaListFoldersHandler } from './handlers/read-handlers.mjs';
import { createMediaUpdateAssetHandler, createMediaMoveAssetsHandler, createMediaDeleteAssetsHandler } from './handlers/write-handlers.mjs';
import { createMediaCreateFolderHandler, createMediaRenameFolderHandler, createMediaMoveFolderHandler, createMediaDeleteFolderHandler } from './handlers/folder-handlers.mjs';
...
export { buildUploadMcpToolDefinitions, registerUploadMcpTools };
//# sourceMappingURL=register-upload-mcp-tools.mjs.map
