...
var inputSchemas = require('./schemas/input-schemas.js');
var outputSchemas = require('./schemas/output-schemas.js');
var readHandlers = require('./handlers/read-handlers.js');
var writeHandlers = require('./handlers/write-handlers.js');
var folderHandlers = require('./handlers/folder-handlers.js');
 ...
 */ const buildUploadMcpToolDefinitions = ()=>[
        {
            ...
            resolveInputSchema: ()=>inputSchemas.mediaListAssetsInputSchema,
            resolveOutputSchema: ()=>outputSchemas.mediaListAssetsOutputSchema,
            createHandler: readHandlers.createMediaListAssetsHandler
        },
        {
            ...
            resolveInputSchema: ()=>inputSchemas.mediaGetAssetInputSchema,
            resolveOutputSchema: ()=>outputSchemas.mediaGetAssetOutputSchema,
            createHandler: readHandlers.createMediaGetAssetHandler
        },
        {
            ...
            resolveOutputSchema: ()=>outputSchemas.mediaListFoldersOutputSchema,
            createHandler: readHandlers.createMediaListFoldersHandler
        },
        {
            ...
            resolveInputSchema: ()=>inputSchemas.mediaUpdateAssetInputSchema,
            resolveOutputSchema: ()=>outputSchemas.mediaUpdateAssetOutputSchema,
            createHandler: writeHandlers.createMediaUpdateAssetHandler
        },
        {
            ...
            resolveInputSchema: ()=>inputSchemas.mediaMoveAssetsInputSchema,
            resolveOutputSchema: ()=>outputSchemas.mediaMoveAssetsOutputSchema,
            createHandler: writeHandlers.createMediaMoveAssetsHandler
        },
        {
            ...
            resolveInputSchema: ()=>inputSchemas.mediaDeleteAssetsInputSchema,
            resolveOutputSchema: ()=>outputSchemas.mediaDeleteAssetsOutputSchema,
            createHandler: writeHandlers.createMediaDeleteAssetsHandler
        },
        {
            ...
            resolveInputSchema: ()=>inputSchemas.mediaCreateFolderInputSchema,
            resolveOutputSchema: ()=>outputSchemas.mediaCreateFolderOutputSchema,
            createHandler: folderHandlers.createMediaCreateFolderHandler
        },
        {
            ...
            resolveInputSchema: ()=>inputSchemas.mediaRenameFolderInputSchema,
            resolveOutputSchema: ()=>outputSchemas.mediaRenameFolderOutputSchema,
            createHandler: folderHandlers.createMediaRenameFolderHandler
        },
        {
            ...
            resolveInputSchema: ()=>inputSchemas.mediaMoveFolderInputSchema,
            resolveOutputSchema: ()=>outputSchemas.mediaMoveFolderOutputSchema,
            createHandler: folderHandlers.createMediaMoveFolderHandler
        },
        {
            ...
            resolveInputSchema: ()=>inputSchemas.mediaDeleteFolderInputSchema,
            resolveOutputSchema: ()=>outputSchemas.mediaDeleteFolderOutputSchema,
            createHandler: folderHandlers.createMediaDeleteFolderHandler
        }
    ];
/**
 ...
 */ const registerUploadMcpTools = ({ strapi })=>{
...
exports.buildUploadMcpToolDefinitions = buildUploadMcpToolDefinitions;
exports.registerUploadMcpTools = registerUploadMcpTools;
//# sourceMappingURL=register-upload-mcp-tools.js.map
