...
/** Coerces a value to a string, or null when it is absent. Timestamps arrive as Date or string. */ const toNullableString = (value)=>{
 ...
 */ const sanitizeMediaAsset = (asset)=>{
    ...
    return {
        ...
        folder: folder !== null && folder !== undefined && folder.id !== undefined ? {
            id: Number(folder.id),
 ...
 */ const sanitizeMediaFolderTree = (nodes)=>{
 ...
 */ const sanitizeMediaFolder = (folder)=>{
...
exports.sanitizeMediaAsset = sanitizeMediaAsset;
exports.sanitizeMediaFolder = sanitizeMediaFolder;
exports.sanitizeMediaFolderTree = sanitizeMediaFolderTree;
//# sourceMappingURL=sanitize-media.js.map
