        ...
        try {
            ...
            for(let i = 0; i < urls.length; i += 1){
                ...
                try {
                    ...
                    const onFetchProgress = ({ bytesWritten, totalBytes })=>{
                        ...
                        if (hasAnnouncedSize && !isFinal && Date.now() - lastProgressAt < URL_FETCH_PROGRESS_INTERVAL_MS) {
                            return;
                        }
                    ...
                    const { file } = await fileService.fetchUrlToInputFile(url, tmpWorkingDirectory, sizeLimit, onFetchProgress);
