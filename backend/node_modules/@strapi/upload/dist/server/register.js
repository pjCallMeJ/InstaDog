...
var registerUploadMcpTools = require('./mcp/register-upload-mcp-tools.js');
 ...
 */ async function register({ strapi }) {
    ...
    registerUploadMcpTools.registerUploadMcpTools({
        strapi
    });
