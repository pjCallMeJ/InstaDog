 ...
 */ const queueConcurrentOperation = (queue, operation)=>{
...
var upload = (({ strapi })=>{
   ...
   */ async function uploadImage(fileData) {
        ...
        // Upload image
        queueConcurrentOperation(uploadPromises, index.getService('provider').upload(fileData));
   ...
   */ async function replaceImage(fileData, oldFile) {
        ...
        queueConcurrentOperation(promises, index.getService('provider').replace(fileData, oldFile));
