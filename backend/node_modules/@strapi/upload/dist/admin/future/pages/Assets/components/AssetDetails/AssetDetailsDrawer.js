 ...
 * -----------------------------------------------------------------------------------------------*/ const useAssetDetailsParam = ()=>{
    ...
    const assetId = useIsAssetDetailsOpen.parseAssetDetailsId(query?.[useIsAssetDetailsOpen.ASSET_DETAILS_URL_PARAM]);
    ...
    const openDetails = React__namespace.useCallback((id)=>{
        setQuery(strapiAdmin.withEncodedUserParams(query, {
            [useIsAssetDetailsOpen.ASSET_DETAILS_URL_PARAM]: String(id)
        }), 'push', true);
    }, [
        query,
        setQuery
    ...
    const closeDetails = React__namespace.useCallback(()=>{
        setQuery(strapiAdmin.withEncodedUserParams(query, {
            [useIsAssetDetailsOpen.ASSET_DETAILS_URL_PARAM]: undefined
        }), 'push', true);
    }, [
        query,
        setQuery
                                    ...
                                    children: [
                                        /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
                                            ...
                                            children: [
                                                ...
                                                canUpdate && /*#__PURE__*/ jsxRuntime.jsx(ReplaceAssetButton, {
                                                    mime: asset.mime
                                                })
                                            ]
                                        }),
 ...
 */ const HeaderIcon = styledComponents.styled(designSystem.Flex)`
  flex-shrink: 0;
`;
const HeaderTitle = styledComponents.styled(designSystem.Typography)`
  min-width: 0;
`;
const DrawerHeader = ({ asset, closeDetails })=>{
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
        ...
        children: [
            /*#__PURE__*/ jsxRuntime.jsx(HeaderIcon, {
            ...
            /*#__PURE__*/ jsxRuntime.jsx(Drawer.Drawer.Title, {
                asChild: true,
                children: /*#__PURE__*/ jsxRuntime.jsx(HeaderTitle, {
                    variant: "omega",
                    fontWeight: "semiBold",
                    overflow: "hidden",
                    ellipsis: true,
 ...
 */ const shouldKeepDrawerOpen = (event, isVisible)=>{
    if (!isVisible) {
        return true;
    }
    ...
    return event.target.closest(constants.ASSET_DETAILS_TRIGGER_SELECTOR) !== null && event.target.closest(constants.ASSET_ITEM_CONTROL_SELECTOR) === null;
};
