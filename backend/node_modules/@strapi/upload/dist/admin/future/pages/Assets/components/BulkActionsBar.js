...
const BulkActionsBar = ({ assets = [], locations = itemLocations.emptyItemLocations, renderedKeys = [] })=>{
    ...
    const [reservedSpace, setReservedSpace] = React.useState(0);
    React.useEffect(()=>{
        if (!barEl) {
            setReservedSpace(0);
            return;
