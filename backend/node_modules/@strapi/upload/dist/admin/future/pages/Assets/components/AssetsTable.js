 ...
 */ const hugColumn = styledComponents.css`
  width: 1%;
  white-space: nowrap;
`;
const flexColumn = styledComponents.css`
  width: 100%;
  max-width: 0;
  overflow: hidden;
`;
...
const StyledTd = styledComponents.styled(designSystem.RawTd)`
  ...
  border-bottom: 1px solid ${({ theme })=>theme.colors.neutral150};
`;
/** The name column: takes whatever the others leave and ellipsizes. */ const NameTd = styledComponents.styled(StyledTd)`
  ${flexColumn}
`;
/** Every other column: as wide as its content, never wrapping. */ const HugTd = styledComponents.styled(StyledTd)`
  ${hugColumn}
`;
...
const AssetRow = ({ asset, orderedItemKeys, onAssetItemClick })=>{
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs(StyledTr, {
        ...
        ...attributes,
        ...listeners,
        ...constants.ASSET_DETAILS_TRIGGER_PROPS,
        ...
        children: [
            canUpdate && /*#__PURE__*/ jsxRuntime.jsx(CheckboxTd, {
                ...constants.ASSET_ITEM_CONTROL_PROPS,
            ...
            /*#__PURE__*/ jsxRuntime.jsx(NameTd, {
...
const AssetsTable = ({ assets, folders = [], mixedItems = null, renderedKeys: renderedKeys$1, onAssetItemClick })=>{
    const isDesktop = strapiAdmin.useIsDesktop();
