...
function requireUser() {
    ...
    const { sanitize, ALLOWED_QUERY_PARAM_KEYS } = require$$1__default.default;
    const { toNumber, getOr, pick } = require$$0__default.default;
    ...
    user = ({ strapi: strapi1 })=>({
	   ...
	   * @return {Promise}
	   */ count (params) {
                const query = strapi1.get('query-params').transform(USER_MODEL_UID, pickAllowedQueryParams(params ?? {}));
                return strapi1.db.query(USER_MODEL_UID).count(query);
            },
            /**
