...
import { __require as requireTrimGrantSessionResponse } from '../trim-grant-session-response.mjs';
...
function requireOauthConnect() {
    ...
    const { trimGrantSessionResponse } = requireTrimGrantSessionResponse();
