var trimGrantSessionResponse_1;
var hasRequiredTrimGrantSessionResponse;
function requireTrimGrantSessionResponse() {
    if (hasRequiredTrimGrantSessionResponse) return trimGrantSessionResponse_1;
    hasRequiredTrimGrantSessionResponse = 1;
    const compact = (value)=>{
	 ...
	 */ const trimGrantSessionResponse = (grantResponse, provider)=>{
        ...
        switch(provider){
            ...
            case 'vk':
                return compact({
                    access_token: grantResponse.access_token,
                    raw: grantResponse.raw?.email != null && grantResponse.raw?.user_id != null ? {
    ...
    trimGrantSessionResponse_1 = {
        trimGrantSessionResponse
    };
    return trimGrantSessionResponse_1;
}

export { requireTrimGrantSessionResponse as __require };
//# sourceMappingURL=trim-grant-session-response.mjs.map
