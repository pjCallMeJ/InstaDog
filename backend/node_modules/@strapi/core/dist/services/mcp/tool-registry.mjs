...
import { toSdkToolResult } from './utils/toSdkMcpCapabilityResult.mjs';
            ...
            return createSafeCapabilityRegistration({
                ...
                registerWithSdk (safeHandler) {
                    ...
                    if (inputSchema !== undefined) {
                        ...
                        const sdkHandler = wrapCapabilityHandlerForMetrics(strapi, 'tool', name, definition.telemetry, async (args, context)=>toSdkToolResult(await safeHandler({
                                args,
                    ...
                    const sdkHandler = wrapCapabilityHandlerForMetrics(strapi, 'tool', name, definition.telemetry, async (context)=>toSdkToolResult(await safeHandler({
                            extra: createMcpCapabilityHandlerContext(context)
                        })));
                    return mcpServer.registerTool(name, {
                        title,
