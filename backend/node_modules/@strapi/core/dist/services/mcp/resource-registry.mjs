...
import { toSdkResourceListingMetadata, toSdkResourceReadResult } from './utils/toSdkMcpCapabilityResult.mjs';
        ...
        super.register((definition)=>{
            ...
            return createSafeCapabilityRegistration({
                ...
                registerWithSdk (safeHandler) {
                    const sdkHandler = wrapCapabilityHandlerForMetrics(strapi, 'resource', name, definition.telemetry, async (uri, context)=>toSdkResourceReadResult(await safeHandler(uri, createMcpCapabilityHandlerContext(context))));
                    return mcpServer.registerResource(name, uri, toSdkResourceListingMetadata(metadata), sdkHandler);
                }
            });
        });
    }
...
export { McpResourceRegistry, makeMcpResourceDefinition };
