        ...
        super.register((definition)=>{
            ...
            return createSafeCapabilityRegistration.createSafeCapabilityRegistration({
                ...
                registerWithSdk (safeHandler) {
                    const sdkHandler = wrapCapabilityHandlerForMetrics.wrapCapabilityHandlerForMetrics(strapi, 'resource', name, definition.telemetry, async (uri, context)=>toSdkMcpCapabilityResult.toSdkResourceReadResult(await safeHandler(uri, createMcpCapabilityHandlerContext.createMcpCapabilityHandlerContext(context))));
