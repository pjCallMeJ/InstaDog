...
const transformParamsToQuery = fp.curry((uid, params$1)=>{
    ...
    if (effectivePublicationFilter !== undefined) {
        ...
        const transformedQuery = fp.assoc('where', baseWhere, fp.assoc('filters', wrappedFilters, queryWithoutPublicationParams));
        return transformedQuery;
    }
    const transformedQuery = fp.assoc('where', baseWhere, stripPublicationParamsFromQuery(query));
    return transformedQuery;
});
